...
COPY ./src/main_sm/fork_10/scripts/rom.json ./src/main_sm/fork_10/scripts/rom.json
COPY ./src/main_sm/fork_10_blob/scripts/blob-rom.json ./src/main_sm/fork_10_blob/scripts/blob-rom.json
