#ifndef STARKS_MULTICHAIN_AGG_STEPS_HPP
#define STARKS_MULTICHAIN_AGG_STEPS_HPP
...
class MultichainAggSteps : public Steps
{
public:
...
#endif // STARKS_MULTICHAIN_AGG_1_STEPS_HPP
