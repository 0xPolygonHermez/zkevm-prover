#ifndef STARKS_MULTICHAIN_AGG_F_STEPS_HPP
#define STARKS_MULTICHAIN_AGG_F_STEPS_HPP
...
class MultichainAggFSteps : public Steps
{
public:
...
#endif // STARKS_MULTICHAIN_PREP_STEPS_HPP
