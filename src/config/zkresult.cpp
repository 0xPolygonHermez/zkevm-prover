...
} resultdesc[] =
{
    ...
    { ZKR_BLOB_OUTER_PROOF_INVALID_INPUT, "ZKR_BLOB_OUTER_PROOF_INVALID_INPUT" },
    ...
    { ZKR_SM_MAIN_OOC_SHA256_F, "ZKR_SM_MAIN_OOC_SHA256_F" },
    ...
    { ZKR_SM_MAIN_BINARY_LT4_MISMATCH, "ZKR_SM_MAIN_BINARY_LT4_MISMATCH"},
    ...
    { ZKR_SM_MAIN_HASHS, "ZKR_SM_MAIN_HASHS" },
    { ZKR_SM_MAIN_HASHS_SIZE_OUT_OF_RANGE, "ZKR_SM_MAIN_HASHS_SIZE_OUT_OF_RANGE" },
    { ZKR_SM_MAIN_HASHS_POSITION_NEGATIVE, "ZKR_SM_MAIN_HASHS_POSITION_NEGATIVE" },
    { ZKR_SM_MAIN_HASHS_POSITION_PLUS_SIZE_OUT_OF_RANGE, "ZKR_SM_MAIN_HASHS_POSITION_PLUS_SIZE_OUT_OF_RANGE" },
    { ZKR_SM_MAIN_HASHSDIGEST_ADDRESS_NOT_FOUND, "ZKR_SM_MAIN_HASHSDIGEST_ADDRESS_NOT_FOUND" },
    { ZKR_SM_MAIN_HASHSDIGEST_NOT_COMPLETED, "ZKR_SM_MAIN_HASHSDIGEST_NOT_COMPLETED" },
    { ZKR_SM_MAIN_HASHS_VALUE_MISMATCH, "ZKR_SM_MAIN_HASHS_VALUE_MISMATCH" },
    { ZKR_SM_MAIN_HASHS_PADDING_MISMATCH, "ZKR_SM_MAIN_HASHS_PADDING_MISMATCH" },
    { ZKR_SM_MAIN_HASHS_SIZE_MISMATCH, "ZKR_SM_MAIN_HASHS_SIZE_MISMATCH" },
    { ZKR_SM_MAIN_HASHSLEN_LENGTH_MISMATCH, "ZKR_SM_MAIN_HASHSLEN_LENGTH_MISMATCH" },
    { ZKR_SM_MAIN_HASHSLEN_CALLED_TWICE, "ZKR_SM_MAIN_HASHSLEN_CALLED_TWICE" },
    { ZKR_SM_MAIN_HASHSDIGEST_NOT_FOUND, "ZKR_SM_MAIN_HASHSDIGEST_NOT_FOUND" },
    { ZKR_SM_MAIN_HASHSDIGEST_DIGEST_MISMATCH, "ZKR_SM_MAIN_HASHSDIGEST_DIGEST_MISMATCH" },
    { ZKR_SM_MAIN_HASHSDIGEST_CALLED_TWICE, "ZKR_SM_MAIN_HASHSDIGEST_CALLED_TWICE" },
    { ZKR_SM_MAIN_HASHS_READ_OUT_OF_RANGE, "ZKR_SM_MAIN_HASHS_READ_OUT_OF_RANGE" },

    { ZKR_SM_MAIN_INVALID_L1_INFO_TREE_INDEX, "ZKR_SM_MAIN_INVALID_L1_INFO_TREE_INDEX" },
    { ZKR_SM_MAIN_INVALID_L1_INFO_TREE_SMT_PROOF_VALUE, "ZKR_SM_MAIN_INVALID_L1_INFO_TREE_SMT_PROOF_VALUE" },
    ...
    { ZKR_SM_MAIN_POINT_Z_MISMATCH, "ZKR_SM_MAIN_POINT_Z_MISMATCH" },
    { ZKR_SM_MAIN_BLOB_L2_HASH_DATA_MISMATCH, "ZKR_SM_MAIN_BLOB_L2_HASH_DATA_MISMATCH" },
    { ZKR_SM_MAIN_BATCH_HASH_DATA_MISMATCH, "ZKR_SM_MAIN_BATCH_HASH_DATA_MISMATCH" },
    { ZKR_SM_MAIN_INVALID_BLOB_TYPE, "ZKR_SM_MAIN_INVALID_BLOB_TYPE" },
    { ZKR_SM_MAIN_UNRESTORED_SAVED_CONTEXT, "ZKR_SM_MAIN_UNRESTORED_SAVED_CONTEXT" },
    { ZKR_BLOB_OUTER_PROOF_INVALID_INPUT, "ZKR_BLOB_OUTER_PROOF_INVALID_INPUT" },
    { ZKR_SM_MAIN_INVALID_MEMORY_CTX, "ZKR_SM_MAIN_INVALID_MEMORY_CTX" }
};
