...
public:
    ...
    inline FieldElement add(FieldElement a, FieldElement b) { return Goldilocks::gl_add(a, b); };
    inline FieldElement sub(FieldElement a, FieldElement b) { return Goldilocks::gl_sub(a, b); };
    inline FieldElement neg(FieldElement a) { return Goldilocks::gl_sub(0, a); };
    inline FieldElement mul(FieldElement a, FieldElement b) { return Goldilocks::gl_mul(a, b); };
    FieldElement inv(FieldElement a);
    inline FieldElement div(FieldElement a, FieldElement b) { return a / b; };
    inline FieldElement square(FieldElement a) { return Goldilocks::gl_mul(a, a); };
    ...
    inline uint64_t prime(void) { return Goldilocks::P; }
    void test(void);
