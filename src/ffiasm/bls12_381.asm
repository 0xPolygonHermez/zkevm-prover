        ...
        global BLS12_381_copy
        global BLS12_381_copyn
        global BLS12_381_add
        global BLS12_381_sub
        global BLS12_381_neg
        global BLS12_381_mul
        global BLS12_381_square
        global BLS12_381_band
        global BLS12_381_bor
        global BLS12_381_bxor
        global BLS12_381_bnot
        global BLS12_381_shl
        global BLS12_381_shr
        global BLS12_381_eq
        global BLS12_381_neq
        global BLS12_381_lt
        global BLS12_381_gt
        global BLS12_381_leq
        global BLS12_381_geq
        global BLS12_381_land
        global BLS12_381_lor
        global BLS12_381_lnot
        global BLS12_381_toNormal
        global BLS12_381_toLongNormal
        global BLS12_381_toMontgomery
        global BLS12_381_toInt
        global BLS12_381_isTrue
        global BLS12_381_q
        global BLS12_381_R3

        global BLS12_381_rawCopy
        global BLS12_381_rawZero
        global BLS12_381_rawSwap
        global BLS12_381_rawAdd
...
BLS12_381_long:
        ...
        mov    rbp, rsp
        bt      rax, 62
        jnc     BLS12_381_longNormal
BLS12_381_longMontgomery:

        sub  rsp, 40
        push rsi
        mov  rsi, rdi
        mov  rdi, rsp
        call BLS12_381_toNormal
        pop  rsi


BLS12_381_longNormal:
        mov     rax, [rdi + 8]
        mov     rcx, rax
        shr     rcx, 31
        jnz     BLS12_381_longNeg
...
;comparison
    cmp r14,[q + 24]
    jc BLS12_381_rawMMul_done
    jnz BLS12_381_rawMMul_sq
    cmp r13,[q + 16]
    jc BLS12_381_rawMMul_done
    jnz BLS12_381_rawMMul_sq
    cmp r12,[q + 8]
    ...
    jc BLS12_381_rawMMul_done
    jnz BLS12_381_rawMMul_sq
BLS12_381_rawMMul_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
BLS12_381_rawMMul_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    cmp r14,[q + 24]
    jc BLS12_381_rawMSquare_done
    jnz BLS12_381_rawMSquare_sq
    cmp r13,[q + 16]
    jc BLS12_381_rawMSquare_done
    jnz BLS12_381_rawMSquare_sq
    cmp r12,[q + 8]
    ...
    jc BLS12_381_rawMSquare_done
    jnz BLS12_381_rawMSquare_sq
BLS12_381_rawMSquare_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
BLS12_381_rawMSquare_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    cmp r14,[q + 24]
    jc BLS12_381_rawMMul1_done
    jnz BLS12_381_rawMMul1_sq
    cmp r13,[q + 16]
    jc BLS12_381_rawMMul1_done
    jnz BLS12_381_rawMMul1_sq
    cmp r12,[q + 8]
    ...
    jc BLS12_381_rawMMul1_done
    jnz BLS12_381_rawMMul1_sq
BLS12_381_rawMMul1_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
BLS12_381_rawMMul1_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    cmp r14,[q + 24]
    jc BLS12_381_rawFromMontgomery_done
    jnz BLS12_381_rawFromMontgomery_sq
    cmp r13,[q + 16]
    jc BLS12_381_rawFromMontgomery_done
    jnz BLS12_381_rawFromMontgomery_sq
    cmp r12,[q + 8]
    ...
    jc BLS12_381_rawFromMontgomery_done
    jnz BLS12_381_rawFromMontgomery_sq
BLS12_381_rawFromMontgomery_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
BLS12_381_rawFromMontgomery_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;;;;;;;;;;;;;;;;;;;;
BLS12_381_rawToMontgomery:
    push    rdx
    lea     rdx, [R2]
    call    BLS12_381_rawMMul
    pop     rdx
    ret
...
toNormalLong:
    add     rdi, 8
    add     rsi, 8
    call    BLS12_381_rawFromMontgomery
    sub     rsi, 8
    sub     rdi, 8
            mov r11b, 0x80
        shl r11d, 24
