        ...
        global nSecp256r1_copy
        global nSecp256r1_copyn
        global nSecp256r1_add
        global nSecp256r1_sub
        global nSecp256r1_neg
        global nSecp256r1_mul
        global nSecp256r1_square
        global nSecp256r1_band
        global nSecp256r1_bor
        global nSecp256r1_bxor
        global nSecp256r1_bnot
        global nSecp256r1_shl
        global nSecp256r1_shr
        global nSecp256r1_eq
        global nSecp256r1_neq
        global nSecp256r1_lt
        global nSecp256r1_gt
        global nSecp256r1_leq
        global nSecp256r1_geq
        global nSecp256r1_land
        global nSecp256r1_lor
        global nSecp256r1_lnot
        global nSecp256r1_toNormal
        global nSecp256r1_toLongNormal
        global nSecp256r1_toMontgomery
        global nSecp256r1_toInt
        global nSecp256r1_isTrue
        global nSecp256r1_q
        global nSecp256r1_R3

        global nSecp256r1_rawCopy
        global nSecp256r1_rawZero
        global nSecp256r1_rawSwap
        global nSecp256r1_rawAdd
        global nSecp256r1_rawSub
        global nSecp256r1_rawNeg
        global nSecp256r1_rawMMul
        global nSecp256r1_rawMSquare
        global nSecp256r1_rawToMontgomery
        global nSecp256r1_rawFromMontgomery
        global nSecp256r1_rawIsEq
        global nSecp256r1_rawIsZero
        global nSecp256r1_rawq
        global nSecp256r1_rawR3

        extern nSecp256r1_fail
        DEFAULT REL
...
nSecp256r1_long:
        ...
        mov    rbp, rsp
        bt      rax, 62
        jnc     nSecp256r1_longNormal
nSecp256r1_longMontgomery:

        sub  rsp, 40
        push rsi
        mov  rsi, rdi
        mov  rdi, rsp
        call nSecp256r1_toNormal
        pop  rsi


nSecp256r1_longNormal:
        mov     rax, [rdi + 8]
        mov     rcx, rax
        shr     rcx, 31
        jnz     nSecp256r1_longNeg
...
;comparison
    test r15,r15
jnz nSecp256r1_rawMMul_sq
    cmp r14,[q + 24]
    jc nSecp256r1_rawMMul_done
    jnz nSecp256r1_rawMMul_sq
    cmp r13,[q + 16]
    jc nSecp256r1_rawMMul_done
    jnz nSecp256r1_rawMMul_sq
    ...
    jc nSecp256r1_rawMMul_done
    jnz nSecp256r1_rawMMul_sq
nSecp256r1_rawMMul_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
nSecp256r1_rawMMul_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    test r15,r15
jnz nSecp256r1_rawMSquare_sq
    cmp r14,[q + 24]
    jc nSecp256r1_rawMSquare_done
    jnz nSecp256r1_rawMSquare_sq
    cmp r13,[q + 16]
    jc nSecp256r1_rawMSquare_done
    jnz nSecp256r1_rawMSquare_sq
    ...
    jc nSecp256r1_rawMSquare_done
    jnz nSecp256r1_rawMSquare_sq
nSecp256r1_rawMSquare_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
nSecp256r1_rawMSquare_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    test r15,r15
jnz nSecp256r1_rawMMul1_sq
    cmp r14,[q + 24]
    jc nSecp256r1_rawMMul1_done
    jnz nSecp256r1_rawMMul1_sq
    cmp r13,[q + 16]
    jc nSecp256r1_rawMMul1_done
    jnz nSecp256r1_rawMMul1_sq
    ...
    jc nSecp256r1_rawMMul1_done
    jnz nSecp256r1_rawMMul1_sq
nSecp256r1_rawMMul1_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
nSecp256r1_rawMMul1_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    test r15,r15
jnz nSecp256r1_rawFromMontgomery_sq
    cmp r14,[q + 24]
    jc nSecp256r1_rawFromMontgomery_done
    jnz nSecp256r1_rawFromMontgomery_sq
    cmp r13,[q + 16]
    jc nSecp256r1_rawFromMontgomery_done
    jnz nSecp256r1_rawFromMontgomery_sq
    ...
    jc nSecp256r1_rawFromMontgomery_done
    jnz nSecp256r1_rawFromMontgomery_sq
nSecp256r1_rawFromMontgomery_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
nSecp256r1_rawFromMontgomery_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;;;;;;;;;;;;;;;;;;;;
nSecp256r1_rawToMontgomery:
    push    rdx
    lea     rdx, [R2]
    call    nSecp256r1_rawMMul
    pop     rdx
    ret
...
toNormalLong:
    add     rdi, 8
    add     rsi, 8
    call    nSecp256r1_rawFromMontgomery
    sub     rsi, 8
    sub     rdi, 8
            mov r11b, 0x80
        shl r11d, 24
...
rawShr:
        cmp rdx, 0
        je nSecp256r1_rawCopy

        cmp rdx, 256
        jae nSecp256r1_rawZero
...
nSecp256r1_q:
        ...
        dd      0x80000000
nSecp256r1_rawq:
q       dq      0xf3b9cac2fc632551,0xbce6faada7179e84,0xffffffffffffffff,0xffffffff00000000
half    dq      0x79dce5617e3192a8,0xde737d56d38bcf42,0x7fffffffffffffff,0x7fffffff80000000
R2      dq      0x83244c95be79eea2,0x4699799c49bd6fa6,0x2845b2392b6bec59,0x66e12d94f3d95620
nSecp256r1_R3:
        dd      0
        dd      0x80000000
nSecp256r1_rawR3:
R3      dq      0xac8ebec90b65a624,0x111f28ae0c0555c9,0x2543b9246ba5e93f,0x503a54e76407be65
lboMask dq      0xffffffffffffffff
np      dq      0xccd1c8aaee00bc4f
