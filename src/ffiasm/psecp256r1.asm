        ...
        global pSecp256r1_copy
        global pSecp256r1_copyn
        global pSecp256r1_add
        global pSecp256r1_sub
        global pSecp256r1_neg
        global pSecp256r1_mul
        global pSecp256r1_square
        global pSecp256r1_band
        global pSecp256r1_bor
        global pSecp256r1_bxor
        global pSecp256r1_bnot
        global pSecp256r1_shl
        global pSecp256r1_shr
        global pSecp256r1_eq
        global pSecp256r1_neq
        global pSecp256r1_lt
        global pSecp256r1_gt
        global pSecp256r1_leq
        global pSecp256r1_geq
        global pSecp256r1_land
        global pSecp256r1_lor
        global pSecp256r1_lnot
        global pSecp256r1_toNormal
        global pSecp256r1_toLongNormal
        global pSecp256r1_toMontgomery
        global pSecp256r1_toInt
        global pSecp256r1_isTrue
        global pSecp256r1_q
        global pSecp256r1_R3

        global pSecp256r1_rawCopy
        global pSecp256r1_rawZero
...
pSecp256r1_long:
        ...
        mov    rbp, rsp
        bt      rax, 62
        jnc     pSecp256r1_longNormal
pSecp256r1_longMontgomery:

        sub  rsp, 40
        push rsi
        mov  rsi, rdi
        mov  rdi, rsp
        call pSecp256r1_toNormal
        pop  rsi


pSecp256r1_longNormal:
        mov     rax, [rdi + 8]
        mov     rcx, rax
        shr     rcx, 31
        jnz     pSecp256r1_longNeg
...
;comparison
    test r15,r15
jnz pSecp256r1_rawMMul_sq
    cmp r14,[q + 24]
    jc pSecp256r1_rawMMul_done
    jnz pSecp256r1_rawMMul_sq
    cmp r13,[q + 16]
    jc pSecp256r1_rawMMul_done
    jnz pSecp256r1_rawMMul_sq
    ...
    jc pSecp256r1_rawMMul_done
    jnz pSecp256r1_rawMMul_sq
pSecp256r1_rawMMul_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
pSecp256r1_rawMMul_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    test r15,r15
jnz pSecp256r1_rawMSquare_sq
    cmp r14,[q + 24]
    jc pSecp256r1_rawMSquare_done
    jnz pSecp256r1_rawMSquare_sq
    cmp r13,[q + 16]
    jc pSecp256r1_rawMSquare_done
    jnz pSecp256r1_rawMSquare_sq
    ...
    jc pSecp256r1_rawMSquare_done
    jnz pSecp256r1_rawMSquare_sq
pSecp256r1_rawMSquare_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
pSecp256r1_rawMSquare_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    test r15,r15
jnz pSecp256r1_rawMMul1_sq
    cmp r14,[q + 24]
    jc pSecp256r1_rawMMul1_done
    jnz pSecp256r1_rawMMul1_sq
    cmp r13,[q + 16]
    jc pSecp256r1_rawMMul1_done
    jnz pSecp256r1_rawMMul1_sq
    ...
    jc pSecp256r1_rawMMul1_done
    jnz pSecp256r1_rawMMul1_sq
pSecp256r1_rawMMul1_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
pSecp256r1_rawMMul1_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;comparison
    test r15,r15
jnz pSecp256r1_rawFromMontgomery_sq
    cmp r14,[q + 24]
    jc pSecp256r1_rawFromMontgomery_done
    jnz pSecp256r1_rawFromMontgomery_sq
    cmp r13,[q + 16]
    jc pSecp256r1_rawFromMontgomery_done
    jnz pSecp256r1_rawFromMontgomery_sq
    ...
    jc pSecp256r1_rawFromMontgomery_done
    jnz pSecp256r1_rawFromMontgomery_sq
pSecp256r1_rawFromMontgomery_sq:
    sub r11,[q +0]
    sbb r12,[q +8]
    sbb r13,[q +16]
    sbb r14,[q +24]
pSecp256r1_rawFromMontgomery_done:
    mov [rdi + 0],r11
    mov [rdi + 8],r12
    mov [rdi + 16],r13
    mov [rdi + 24],r14
...
;;;;;;;;;;;;;;;;;;;;
pSecp256r1_rawToMontgomery:
    push    rdx
    lea     rdx, [R2]
    call    pSecp256r1_rawMMul
    pop     rdx
    ret
...
toNormalLong:
    add     rdi, 8
    add     rsi, 8
    call    pSecp256r1_rawFromMontgomery
    sub     rsi, 8
    sub     rdi, 8
            mov r11b, 0x80
        shl r11d, 24
