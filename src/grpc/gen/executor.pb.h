...
enum Error : int {
  ...
  ERROR_INVALID_JUMP = 20,
  ERROR_INVALID_OPCODE = 21,
  ERROR_INVALID_STATIC = 22,
  ERROR_INVALID_BYTECODE_STARTS_EF = 23,
  ERROR_INTRINSIC_INVALID_SIGNATURE = 24,
  ERROR_INTRINSIC_INVALID_CHAIN_ID = 25,
  ERROR_INTRINSIC_INVALID_NONCE = 26,
  ERROR_INTRINSIC_INVALID_GAS_LIMIT = 27,
  ERROR_INTRINSIC_INVALID_BALANCE = 28,
  ERROR_INTRINSIC_INVALID_BATCH_GAS_LIMIT = 29,
  ERROR_INTRINSIC_INVALID_SENDER_CODE = 30,
  ERROR_INTRINSIC_TX_GAS_OVERFLOW = 31,
  ERROR_BATCH_DATA_TOO_BIG = 32,
