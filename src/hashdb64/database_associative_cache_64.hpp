#ifndef DATABASE_ASSOCIATIVE_CACHE_64_HPP
#define DATABASE_ASSOCIATIVE_CACHE_64_HPP
#include <vector>
...
class DatabaseMTAssociativeCache64
{
    private:
    ...
    public:
        ...
        DatabaseMTAssociativeCache64();
        DatabaseMTAssociativeCache64(int nKeyBits_, int log2CacheSize_, string name_);
        ~DatabaseMTAssociativeCache64();
