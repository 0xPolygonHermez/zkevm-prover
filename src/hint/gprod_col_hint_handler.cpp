#include "gprod_col_hint_handler.hpp"

namespace Hints
{
    std::string GProdColHintHandler::getName()
    {
        return "gprod_col";
    }

    std::vector<std::string> GProdColHintHandler::getSources() const
    {
        return {"numerator", "denominator"};
    }

    std::vector<std::string> GProdColHintHandler::getDestinations() const
    {
        return {"reference"};
    }

    void GProdColHintHandler::resolveHint(int N, StepsParams &params, Hint hint, const std::map<std::string, Polinomial *> &polynomials) const
    {
    ...
    void GProdColHintHandler::calculateZ(Polinomial &z, Polinomial &num, Polinomial &den) const
    {
    ...
    std::shared_ptr<HintHandler> GProdColHintHandlerBuilder::build() const
    {
        return std::make_unique<GProdColHintHandler>();
    }
}