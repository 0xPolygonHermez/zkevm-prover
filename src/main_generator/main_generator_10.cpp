    ...
    for (uint64_t zkPC=0; zkPC < rom["program"].size(); zkPC++)
    {
        ...
        if (rom["program"][zkPC].contains("inFREE"))
        {
                 ...
                 (rom["program"][zkPC]["freeInTag"]["op"] == "") )
            {
                ...
                {
                    code += "    zkPC=" + to_string(zkPC) +";\n";
                    code += "    zkResult = HashK_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);\n";
                    code += "    if (zkResult != ZKR_SUCCESS)\n";
                    code += "    {\n";
                    code += "        proverRequest.result = zkResult;\n";
                ...
                {
                    code += "    zkPC=" + to_string(zkPC) +";\n";
                    code += "    zkResult = HashKDigest_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);\n";
                    code += "    if (zkResult != ZKR_SUCCESS)\n";
                    code += "    {\n";
                    code += "        proverRequest.result = zkResult;\n";
                ...
                {
                    code += "    zkPC=" + to_string(zkPC) +";\n";
                    code += "    zkResult = HashKLen_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);\n";
                    code += "    if (zkResult != ZKR_SUCCESS)\n";
                    code += "    {\n";
                    code += "        proverRequest.result = zkResult;\n";
                    code += "        mainExecutor.logError(ctx, \"Failed calling HashKLen_calculate() result=\" + zkresult2string(zkResult));\n";
                    code += "        pHashDB->cancelBatch(proverRequest.uuid);\n";
                    code += "        return;\n";
                    code += "    }\n";
                    nHits++;
        ...
        {
            code += "    zkPC=" + to_string(zkPC) +";\n";
            code += "    zkResult = HashK_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, " + (bFastMode ? string("NULL") : string("&required")) + ", hashAddr);\n";
            code += "    if (zkResult != ZKR_SUCCESS)\n";
            code += "    {\n";
            code += "        proverRequest.result = zkResult;\n";
        ...
        {
            code += "    zkPC=" + to_string(zkPC) +";\n";
            code += "    zkResult = HashKLen_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, " + (bFastMode ? string("NULL") : string("&required")) + ", hashAddr);\n";
            code += "    if (zkResult != ZKR_SUCCESS)\n";
            code += "    {\n";
            code += "        proverRequest.result = zkResult;\n";
        ...
        {
            code += "    zkPC=" + to_string(zkPC) +";\n";
            code += "    zkResult = HashKDigest_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, " + (bFastMode ? string("NULL") : string("&required")) + ", hashAddr);\n";
            code += "    if (zkResult != ZKR_SUCCESS)\n";
            code += "    {\n";
            code += "        proverRequest.result = zkResult;\n";
