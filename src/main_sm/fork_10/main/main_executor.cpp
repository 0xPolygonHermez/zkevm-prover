    ...
    for (step=0; step<N_Max; step++)
    {
        ...
        if (!fr.isZero(rom.line[zkPC].inFREE) || !fr.isZero(rom.line[zkPC].inFREE0))
        {
            ...
            if (rom.line[zkPC].freeInTag.op == op_empty)
            {
                ...
                {
                    Memory_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, memAddr);
                    nHits++;
                }
                ...
                {
                    zkresult zkr = HashK_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    if (zkr != ZKR_SUCCESS)
                    {
                        proverRequest.result = zkr;
                ...
                {
                    zkresult zkr = HashKDigest_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    if (zkr != ZKR_SUCCESS)
                    {
                        proverRequest.result = zkr;
                ...
                {
                    HashKLen_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    nHits++;
                }
                ...
                {
                    zkresult zkr = HashP_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    if (zkr != ZKR_SUCCESS)
                    {
                        proverRequest.result = zkr;
                ...
                {
                    zkresult zkr = HashPDigest_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    if (zkr != ZKR_SUCCESS)
                    {
                        proverRequest.result = zkr;
                ...
                {
                    HashPLen_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    nHits++;
                }
                ...
                {
                    zkresult zkr = HashS_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    if (zkr != ZKR_SUCCESS)
                    {
                        proverRequest.result = zkr;
                ...
                {
                    zkresult zkr = HashSDigest_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    if (zkr != ZKR_SUCCESS)
                    {
                        proverRequest.result = zkr;
                ...
                {
                    HashSLen_calculate(ctx, fi0, fi1, fi2, fi3, fi4, fi5, fi6, fi7, hashAddr);
                    nHits++;
                }
        ...
        if (rom.line[zkPC].mOp == 1)
        {
            zkresult zkr = Memory_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, memAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        if ( rom.line[zkPC].hashK == 1 )
        {
            zkresult zkr = HashK_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        {
            zkresult zkr = HashKLen_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        if (rom.line[zkPC].hashKDigest == 1)
        {
            zkresult zkr = HashKDigest_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        if (rom.line[zkPC].hashP == 1)
        {
            zkresult zkr = HashP_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        {
            zkresult zkr = HashPLen_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        if (rom.line[zkPC].hashPDigest == 1)
        {
            zkresult zkr = HashPDigest_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        if (rom.line[zkPC].hashS == 1)
        {
            zkresult zkr = HashS_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        {
            zkresult zkr = HashSLen_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
        ...
        if (rom.line[zkPC].hashSDigest == 1)
        {
            zkresult zkr = HashSDigest_verify(ctx, op0, op1, op2, op3, op4, op5, op6, op7, &required, hashAddr);
            if (zkr != ZKR_SUCCESS)
            {
                proverRequest.result = zkr;
