...
public:
    ...
    inline Goldilocks::Element & operator[](uint64_t i) { return _pAddress[i*233]; };
...
public:
    ...
    ClimbKeyConstantPols (void * pAddress, uint64_t degree) :
        FACTOR((Goldilocks::Element *)((uint8_t *)pAddress + 1192), degree, 149),
        T_CLKEYSEL((Goldilocks::Element *)((uint8_t *)pAddress + 1200), degree, 150),
        T_LEVEL((Goldilocks::Element *)((uint8_t *)pAddress + 1208), degree, 151),
        T_CHUNK_VALUE((Goldilocks::Element *)((uint8_t *)pAddress + 1216), degree, 152),
        T_CARRYLT_IN((Goldilocks::Element *)((uint8_t *)pAddress + 1224), degree, 153),
        T_CARRYLT_OUT((Goldilocks::Element *)((uint8_t *)pAddress + 1232), degree, 154),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    StorageConstantPols (void * pAddress, uint64_t degree) :
        OPERATION((Goldilocks::Element *)((uint8_t *)pAddress + 1240), degree, 155),
        CONST0((Goldilocks::Element *)((uint8_t *)pAddress + 1248), degree, 156),
        JMP_ADDRESS((Goldilocks::Element *)((uint8_t *)pAddress + 1256), degree, 157),
        LINE((Goldilocks::Element *)((uint8_t *)pAddress + 1264), degree, 158),
        IN_SIBLING_RKEY((Goldilocks::Element *)((uint8_t *)pAddress + 1272), degree, 159),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    KeccakFConstantPols (void * pAddress, uint64_t degree) :
        ConnA((Goldilocks::Element *)((uint8_t *)pAddress + 1280), degree, 160),
        ConnB((Goldilocks::Element *)((uint8_t *)pAddress + 1288), degree, 161),
        ConnC((Goldilocks::Element *)((uint8_t *)pAddress + 1296), degree, 162),
        GateType((Goldilocks::Element *)((uint8_t *)pAddress + 1304), degree, 163),
        kGateType((Goldilocks::Element *)((uint8_t *)pAddress + 1312), degree, 164),
        kA((Goldilocks::Element *)((uint8_t *)pAddress + 1320), degree, 165),
        kB((Goldilocks::Element *)((uint8_t *)pAddress + 1328), degree, 166),
        kC((Goldilocks::Element *)((uint8_t *)pAddress + 1336), degree, 167),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    Bits2FieldConstantPols (void * pAddress, uint64_t degree) :
        FieldLatch((Goldilocks::Element *)((uint8_t *)pAddress + 1344), degree, 168),
        Factor((Goldilocks::Element *)((uint8_t *)pAddress + 1352), degree, 169),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    PaddingKKBitConstantPols (void * pAddress, uint64_t degree) :
        r8Id((Goldilocks::Element *)((uint8_t *)pAddress + 1360), degree, 170),
        sOutId((Goldilocks::Element *)((uint8_t *)pAddress + 1368), degree, 171),
        latchR8((Goldilocks::Element *)((uint8_t *)pAddress + 1376), degree, 172),
        Fr8((Goldilocks::Element *)((uint8_t *)pAddress + 1384), degree, 173),
        rBitValid((Goldilocks::Element *)((uint8_t *)pAddress + 1392), degree, 174),
        latchSOut((Goldilocks::Element *)((uint8_t *)pAddress + 1400), degree, 175),
        FSOut0((Goldilocks::Element *)((uint8_t *)pAddress + 1408), degree, 176),
        FSOut1((Goldilocks::Element *)((uint8_t *)pAddress + 1416), degree, 177),
        FSOut2((Goldilocks::Element *)((uint8_t *)pAddress + 1424), degree, 178),
        FSOut3((Goldilocks::Element *)((uint8_t *)pAddress + 1432), degree, 179),
        FSOut4((Goldilocks::Element *)((uint8_t *)pAddress + 1440), degree, 180),
        FSOut5((Goldilocks::Element *)((uint8_t *)pAddress + 1448), degree, 181),
        FSOut6((Goldilocks::Element *)((uint8_t *)pAddress + 1456), degree, 182),
        FSOut7((Goldilocks::Element *)((uint8_t *)pAddress + 1464), degree, 183),
        ConnSOutBit((Goldilocks::Element *)((uint8_t *)pAddress + 1472), degree, 184),
        ConnSInBit((Goldilocks::Element *)((uint8_t *)pAddress + 1480), degree, 185),
        ConnBits2FieldBit((Goldilocks::Element *)((uint8_t *)pAddress + 1488), degree, 186),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    PaddingKKConstantPols (void * pAddress, uint64_t degree) :
        r8Id((Goldilocks::Element *)((uint8_t *)pAddress + 1496), degree, 187),
        lastBlock((Goldilocks::Element *)((uint8_t *)pAddress + 1504), degree, 188),
        lastBlockLatch((Goldilocks::Element *)((uint8_t *)pAddress + 1512), degree, 189),
        r8valid((Goldilocks::Element *)((uint8_t *)pAddress + 1520), degree, 190),
        sOutId((Goldilocks::Element *)((uint8_t *)pAddress + 1528), degree, 191),
        forceLastHash((Goldilocks::Element *)((uint8_t *)pAddress + 1536), degree, 192),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    Sha256FConstantPols (void * pAddress, uint64_t degree) :
        kGateType((Goldilocks::Element *)((uint8_t *)pAddress + 1544), degree, 193),
        kA((Goldilocks::Element *)((uint8_t *)pAddress + 1552), degree, 194),
        kB((Goldilocks::Element *)((uint8_t *)pAddress + 1560), degree, 195),
        kC((Goldilocks::Element *)((uint8_t *)pAddress + 1568), degree, 196),
        kOut((Goldilocks::Element *)((uint8_t *)pAddress + 1576), degree, 197),
        kCarryOut((Goldilocks::Element *)((uint8_t *)pAddress + 1584), degree, 198),
        Conn{
            ConstantPol((Goldilocks::Element *)((uint8_t *)pAddress + 1592), degree, 199),
        ...
        GATE_TYPE((Goldilocks::Element *)((uint8_t *)pAddress + 1624), degree, 203),
        CARRY_ENABLED((Goldilocks::Element *)((uint8_t *)pAddress + 1632), degree, 204),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    Bits2FieldSha256ConstantPols (void * pAddress, uint64_t degree) :
        FieldLatch((Goldilocks::Element *)((uint8_t *)pAddress + 1640), degree, 205),
        Factor((Goldilocks::Element *)((uint8_t *)pAddress + 1648), degree, 206),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    PaddingSha256BitConstantPols (void * pAddress, uint64_t degree) :
        r8Id((Goldilocks::Element *)((uint8_t *)pAddress + 1656), degree, 207),
        sOutId((Goldilocks::Element *)((uint8_t *)pAddress + 1664), degree, 208),
        latchR8((Goldilocks::Element *)((uint8_t *)pAddress + 1672), degree, 209),
        Fr8((Goldilocks::Element *)((uint8_t *)pAddress + 1680), degree, 210),
        latchSOut((Goldilocks::Element *)((uint8_t *)pAddress + 1688), degree, 211),
        FSOut0((Goldilocks::Element *)((uint8_t *)pAddress + 1696), degree, 212),
        FSOut1((Goldilocks::Element *)((uint8_t *)pAddress + 1704), degree, 213),
        FSOut2((Goldilocks::Element *)((uint8_t *)pAddress + 1712), degree, 214),
        FSOut3((Goldilocks::Element *)((uint8_t *)pAddress + 1720), degree, 215),
        FSOut4((Goldilocks::Element *)((uint8_t *)pAddress + 1728), degree, 216),
        FSOut5((Goldilocks::Element *)((uint8_t *)pAddress + 1736), degree, 217),
        FSOut6((Goldilocks::Element *)((uint8_t *)pAddress + 1744), degree, 218),
        FSOut7((Goldilocks::Element *)((uint8_t *)pAddress + 1752), degree, 219),
        HIn((Goldilocks::Element *)((uint8_t *)pAddress + 1760), degree, 220),
        DoConnect((Goldilocks::Element *)((uint8_t *)pAddress + 1768), degree, 221),
        ConnS1((Goldilocks::Element *)((uint8_t *)pAddress + 1776), degree, 222),
        ConnS2((Goldilocks::Element *)((uint8_t *)pAddress + 1784), degree, 223),
        ConnBits2FieldBit((Goldilocks::Element *)((uint8_t *)pAddress + 1792), degree, 224),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    PaddingSha256ConstantPols (void * pAddress, uint64_t degree) :
        r8Id((Goldilocks::Element *)((uint8_t *)pAddress + 1800), degree, 225),
        lastBlock((Goldilocks::Element *)((uint8_t *)pAddress + 1808), degree, 226),
        lastBlockLatch((Goldilocks::Element *)((uint8_t *)pAddress + 1816), degree, 227),
        r8valid((Goldilocks::Element *)((uint8_t *)pAddress + 1824), degree, 228),
        PrevLengthSection((Goldilocks::Element *)((uint8_t *)pAddress + 1832), degree, 229),
        LengthWeight((Goldilocks::Element *)((uint8_t *)pAddress + 1840), degree, 230),
        sOutId((Goldilocks::Element *)((uint8_t *)pAddress + 1848), degree, 231),
        forceLastHash((Goldilocks::Element *)((uint8_t *)pAddress + 1856), degree, 232),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    inline static uint64_t pilSize (void) { return 15636365312; }
    inline static uint64_t pilDegree (void) { return 8388608; }
    inline static uint64_t numPols (void) { return 233; }

    inline void * address (void) { return _pAddress; }
    inline uint64_t degree (void) { return _degree; }
    inline uint64_t size (void) { return _degree*233*sizeof(Goldilocks::Element); }
...
inline const char * address2ConstantPolName (uint64_t address)
{
    ...
    if ((address >= 1192) && (address <= 1199)) return "ClimbKey.FACTOR";
    if ((address >= 1200) && (address <= 1207)) return "ClimbKey.T_CLKEYSEL";
    if ((address >= 1208) && (address <= 1215)) return "ClimbKey.T_LEVEL";
    if ((address >= 1216) && (address <= 1223)) return "ClimbKey.T_CHUNK_VALUE";
    if ((address >= 1224) && (address <= 1231)) return "ClimbKey.T_CARRYLT_IN";
    if ((address >= 1232) && (address <= 1239)) return "ClimbKey.T_CARRYLT_OUT";
    if ((address >= 1240) && (address <= 1247)) return "Storage.OPERATION";
    if ((address >= 1248) && (address <= 1255)) return "Storage.CONST0";
    if ((address >= 1256) && (address <= 1263)) return "Storage.JMP_ADDRESS";
    if ((address >= 1264) && (address <= 1271)) return "Storage.LINE";
    if ((address >= 1272) && (address <= 1279)) return "Storage.IN_SIBLING_RKEY";
    if ((address >= 1280) && (address <= 1287)) return "KeccakF.ConnA";
    if ((address >= 1288) && (address <= 1295)) return "KeccakF.ConnB";
    if ((address >= 1296) && (address <= 1303)) return "KeccakF.ConnC";
    if ((address >= 1304) && (address <= 1311)) return "KeccakF.GateType";
    if ((address >= 1312) && (address <= 1319)) return "KeccakF.kGateType";
    if ((address >= 1320) && (address <= 1327)) return "KeccakF.kA";
    if ((address >= 1328) && (address <= 1335)) return "KeccakF.kB";
    if ((address >= 1336) && (address <= 1343)) return "KeccakF.kC";
    if ((address >= 1344) && (address <= 1351)) return "Bits2Field.FieldLatch";
    if ((address >= 1352) && (address <= 1359)) return "Bits2Field.Factor";
    if ((address >= 1360) && (address <= 1367)) return "PaddingKKBit.r8Id";
    if ((address >= 1368) && (address <= 1375)) return "PaddingKKBit.sOutId";
    if ((address >= 1376) && (address <= 1383)) return "PaddingKKBit.latchR8";
    if ((address >= 1384) && (address <= 1391)) return "PaddingKKBit.Fr8";
    if ((address >= 1392) && (address <= 1399)) return "PaddingKKBit.rBitValid";
    if ((address >= 1400) && (address <= 1407)) return "PaddingKKBit.latchSOut";
    if ((address >= 1408) && (address <= 1415)) return "PaddingKKBit.FSOut0";
    if ((address >= 1416) && (address <= 1423)) return "PaddingKKBit.FSOut1";
    if ((address >= 1424) && (address <= 1431)) return "PaddingKKBit.FSOut2";
    if ((address >= 1432) && (address <= 1439)) return "PaddingKKBit.FSOut3";
    if ((address >= 1440) && (address <= 1447)) return "PaddingKKBit.FSOut4";
    if ((address >= 1448) && (address <= 1455)) return "PaddingKKBit.FSOut5";
    if ((address >= 1456) && (address <= 1463)) return "PaddingKKBit.FSOut6";
    if ((address >= 1464) && (address <= 1471)) return "PaddingKKBit.FSOut7";
    if ((address >= 1472) && (address <= 1479)) return "PaddingKKBit.ConnSOutBit";
    if ((address >= 1480) && (address <= 1487)) return "PaddingKKBit.ConnSInBit";
    if ((address >= 1488) && (address <= 1495)) return "PaddingKKBit.ConnBits2FieldBit";
    if ((address >= 1496) && (address <= 1503)) return "PaddingKK.r8Id";
    if ((address >= 1504) && (address <= 1511)) return "PaddingKK.lastBlock";
    if ((address >= 1512) && (address <= 1519)) return "PaddingKK.lastBlockLatch";
    if ((address >= 1520) && (address <= 1527)) return "PaddingKK.r8valid";
    if ((address >= 1528) && (address <= 1535)) return "PaddingKK.sOutId";
    if ((address >= 1536) && (address <= 1543)) return "PaddingKK.forceLastHash";
    if ((address >= 1544) && (address <= 1551)) return "Sha256F.kGateType";
    if ((address >= 1552) && (address <= 1559)) return "Sha256F.kA";
    if ((address >= 1560) && (address <= 1567)) return "Sha256F.kB";
    if ((address >= 1568) && (address <= 1575)) return "Sha256F.kC";
    if ((address >= 1576) && (address <= 1583)) return "Sha256F.kOut";
    if ((address >= 1584) && (address <= 1591)) return "Sha256F.kCarryOut";
    if ((address >= 1592) && (address <= 1599)) return "Sha256F.Conn[0]";
    if ((address >= 1600) && (address <= 1607)) return "Sha256F.Conn[1]";
    if ((address >= 1608) && (address <= 1615)) return "Sha256F.Conn[2]";
    if ((address >= 1616) && (address <= 1623)) return "Sha256F.Conn[3]";
    if ((address >= 1624) && (address <= 1631)) return "Sha256F.GATE_TYPE";
    if ((address >= 1632) && (address <= 1639)) return "Sha256F.CARRY_ENABLED";
    if ((address >= 1640) && (address <= 1647)) return "Bits2FieldSha256.FieldLatch";
    if ((address >= 1648) && (address <= 1655)) return "Bits2FieldSha256.Factor";
    if ((address >= 1656) && (address <= 1663)) return "PaddingSha256Bit.r8Id";
    if ((address >= 1664) && (address <= 1671)) return "PaddingSha256Bit.sOutId";
    if ((address >= 1672) && (address <= 1679)) return "PaddingSha256Bit.latchR8";
    if ((address >= 1680) && (address <= 1687)) return "PaddingSha256Bit.Fr8";
    if ((address >= 1688) && (address <= 1695)) return "PaddingSha256Bit.latchSOut";
    if ((address >= 1696) && (address <= 1703)) return "PaddingSha256Bit.FSOut0";
    if ((address >= 1704) && (address <= 1711)) return "PaddingSha256Bit.FSOut1";
    if ((address >= 1712) && (address <= 1719)) return "PaddingSha256Bit.FSOut2";
    if ((address >= 1720) && (address <= 1727)) return "PaddingSha256Bit.FSOut3";
    if ((address >= 1728) && (address <= 1735)) return "PaddingSha256Bit.FSOut4";
    if ((address >= 1736) && (address <= 1743)) return "PaddingSha256Bit.FSOut5";
    if ((address >= 1744) && (address <= 1751)) return "PaddingSha256Bit.FSOut6";
    if ((address >= 1752) && (address <= 1759)) return "PaddingSha256Bit.FSOut7";
    if ((address >= 1760) && (address <= 1767)) return "PaddingSha256Bit.HIn";
    if ((address >= 1768) && (address <= 1775)) return "PaddingSha256Bit.DoConnect";
    if ((address >= 1776) && (address <= 1783)) return "PaddingSha256Bit.ConnS1";
    if ((address >= 1784) && (address <= 1791)) return "PaddingSha256Bit.ConnS2";
    if ((address >= 1792) && (address <= 1799)) return "PaddingSha256Bit.ConnBits2FieldBit";
    if ((address >= 1800) && (address <= 1807)) return "PaddingSha256.r8Id";
    if ((address >= 1808) && (address <= 1815)) return "PaddingSha256.lastBlock";
    if ((address >= 1816) && (address <= 1823)) return "PaddingSha256.lastBlockLatch";
    if ((address >= 1824) && (address <= 1831)) return "PaddingSha256.r8valid";
    if ((address >= 1832) && (address <= 1839)) return "PaddingSha256.PrevLengthSection";
    if ((address >= 1840) && (address <= 1847)) return "PaddingSha256.LengthWeight";
    if ((address >= 1848) && (address <= 1855)) return "PaddingSha256.sOutId";
    if ((address >= 1856) && (address <= 1863)) return "PaddingSha256.forceLastHash";
