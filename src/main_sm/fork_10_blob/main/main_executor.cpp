...
#include "main_sm/fork_10_blob/main/rom.hpp"
#include "main_sm/fork_10_blob/main/context.hpp"
#include "main_sm/fork_10_blob/main/eval_command.hpp"
    ...
    config(config)
{
    ...
    file2json("src/main_sm/fork_10_blob/scripts/rom_collection.json", romJson);
    romCollection.load(fr, romJson);

#ifdef MULTI_ROM_TEST
    romJson.clear();
    file2json("src/main_sm/fork_10_blob/scripts/rom_gas_limit_100000000.json", romJson);
    rom_gas_limit_100000000.load(fr, romJson);
    romJson.clear();
    file2json("src/main_sm/fork_10_blob/scripts/rom_gas_limit_2147483647.json", romJson);
    rom_gas_limit_2147483647.load(fr, romJson);
    romJson.clear();
    file2json("src/main_sm/fork_10_blob/scripts/rom_gas_limit_89128960.json", romJson);
