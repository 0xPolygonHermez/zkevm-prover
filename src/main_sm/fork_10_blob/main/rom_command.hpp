#ifndef ROM_COMMAND_HPP_fork_10_blob
#define ROM_COMMAND_HPP_fork_10_blob
...
typedef enum : int {
    ...
    f_ARITH_BLS12381_MULFP2_X,
    f_ARITH_BLS12381_MULFP2_Y,
    f_ARITH_BLS12381_ADDFP2,
    f_ARITH_BLS12381_SUBFP2,
    f_FROM_384_TO_256_H,
    f_FROM_384_TO_256_L,
    f_fp2InvBN254_x,
    f_fp2InvBN254_y,
