...
public:
    ...
    inline Goldilocks::Element & operator[](uint64_t i) { return _pAddress[i*757]; };
...
public:
    ...
    MainCommitPols (void * pAddress, uint64_t degree) :
        ...
        arith((Goldilocks::Element *)((uint8_t *)pAddress + 5488), degree, 686),
        arithEq((Goldilocks::Element *)((uint8_t *)pAddress + 5496), degree, 687),
        arithSame12((Goldilocks::Element *)((uint8_t *)pAddress + 5504), degree, 688),
        arithUseE((Goldilocks::Element *)((uint8_t *)pAddress + 5512), degree, 689),
        ...
        op0((Goldilocks::Element *)((uint8_t *)pAddress + 5816), degree, 727),
        op1((Goldilocks::Element *)((uint8_t *)pAddress + 5824), degree, 728),
        op2((Goldilocks::Element *)((uint8_t *)pAddress + 5832), degree, 729),
        op3((Goldilocks::Element *)((uint8_t *)pAddress + 5840), degree, 730),
        op4((Goldilocks::Element *)((uint8_t *)pAddress + 5848), degree, 731),
        op5((Goldilocks::Element *)((uint8_t *)pAddress + 5856), degree, 732),
        op6((Goldilocks::Element *)((uint8_t *)pAddress + 5864), degree, 733),
        op7((Goldilocks::Element *)((uint8_t *)pAddress + 5872), degree, 734),
        lJmpnCondValue((Goldilocks::Element *)((uint8_t *)pAddress + 5880), degree, 735),
        hJmpnCondValueBit{
        ...
        RCXInv((Goldilocks::Element *)((uint8_t *)pAddress + 5944), degree, 743),
        op0Inv((Goldilocks::Element *)((uint8_t *)pAddress + 5952), degree, 744),
        jmpAddr((Goldilocks::Element *)((uint8_t *)pAddress + 5960), degree, 745),
        elseAddr((Goldilocks::Element *)((uint8_t *)pAddress + 5968), degree, 746),
        useJmpAddr((Goldilocks::Element *)((uint8_t *)pAddress + 5976), degree, 747),
        useElseAddr((Goldilocks::Element *)((uint8_t *)pAddress + 5984), degree, 748),
        sKeyI{
...
public:
    ...
    inline static uint64_t numPols (void) { return 757; }

    inline void * address (void) { return _pAddress; }
    inline uint64_t degree (void) { return _degree; }
    inline uint64_t size (void) { return _degree*757*sizeof(Goldilocks::Element); }
...
inline const char * address2CommitPolName (uint64_t address)
{
    ...
    if ((address >= 1848) && (address <= 1855)) return "Arith.selEq[8]";
    if ((address >= 1856) && (address <= 1863)) return "Arith.selEq[9]";
    ...
    if ((address >= 5488) && (address <= 5495)) return "Main.arith";
    if ((address >= 5496) && (address <= 5503)) return "Main.arithEq";
    if ((address >= 5504) && (address <= 5511)) return "Main.arithSame12";
    if ((address >= 5512) && (address <= 5519)) return "Main.arithUseE";
    ...
    if ((address >= 5816) && (address <= 5823)) return "Main.op0";
    if ((address >= 5824) && (address <= 5831)) return "Main.op1";
    if ((address >= 5832) && (address <= 5839)) return "Main.op2";
    if ((address >= 5840) && (address <= 5847)) return "Main.op3";
    if ((address >= 5848) && (address <= 5855)) return "Main.op4";
    if ((address >= 5856) && (address <= 5863)) return "Main.op5";
    if ((address >= 5864) && (address <= 5871)) return "Main.op6";
    if ((address >= 5872) && (address <= 5879)) return "Main.op7";
    if ((address >= 5880) && (address <= 5887)) return "Main.lJmpnCondValue";
    if ((address >= 5888) && (address <= 5895)) return "Main.hJmpnCondValueBit[0]";
    if ((address >= 5896) && (address <= 5903)) return "Main.hJmpnCondValueBit[1]";
    if ((address >= 5904) && (address <= 5911)) return "Main.hJmpnCondValueBit[2]";
    if ((address >= 5912) && (address <= 5919)) return "Main.hJmpnCondValueBit[3]";
    if ((address >= 5920) && (address <= 5927)) return "Main.hJmpnCondValueBit[4]";
    if ((address >= 5928) && (address <= 5935)) return "Main.hJmpnCondValueBit[5]";
    if ((address >= 5936) && (address <= 5943)) return "Main.hJmpnCondValueBit[6]";
    if ((address >= 5944) && (address <= 5951)) return "Main.RCXInv";
    if ((address >= 5952) && (address <= 5959)) return "Main.op0Inv";
    if ((address >= 5960) && (address <= 5967)) return "Main.jmpAddr";
    if ((address >= 5968) && (address <= 5975)) return "Main.elseAddr";
    if ((address >= 5976) && (address <= 5983)) return "Main.useJmpAddr";
    if ((address >= 5984) && (address <= 5991)) return "Main.useElseAddr";
    if ((address >= 5992) && (address <= 5999)) return "Main.sKeyI[0]";
    if ((address >= 6000) && (address <= 6007)) return "Main.sKeyI[1]";
    if ((address >= 6008) && (address <= 6015)) return "Main.sKeyI[2]";
    if ((address >= 6016) && (address <= 6023)) return "Main.sKeyI[3]";
    if ((address >= 6024) && (address <= 6031)) return "Main.sKey[0]";
    if ((address >= 6032) && (address <= 6039)) return "Main.sKey[1]";
    if ((address >= 6040) && (address <= 6047)) return "Main.sKey[2]";
    if ((address >= 6048) && (address <= 6055)) return "Main.sKey[3]";
