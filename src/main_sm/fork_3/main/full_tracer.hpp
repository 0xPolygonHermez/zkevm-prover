#ifndef FULL_TRACER_HPP_fork_3
#define FULL_TRACER_HPP_fork_3
...
public:
    ...
    FullTracer(Goldilocks &fr) : fr(fr), depth(1), initGas(0), txCount(0), txTime(0), accBatchGas(0), numberOfOpcodesInThisTx(0), lastErrorOpcode(0), bOpcodeCalled(false) { };
    ~FullTracer()
    {
#ifdef LOG_TIME_STATISTICS
