...
public:
    ...
    virtual int setProgram (const Goldilocks::Element (&key)[4], const vector<uint8_t> &data, const bool persistent) = 0;
    virtual int getProgram (const Goldilocks::Element (&key)[4], vector<uint8_t> &data) = 0;
