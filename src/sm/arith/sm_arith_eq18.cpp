...
int64_t eq18 (Goldilocks &fr, ArithCommitPols &p, uint64_t step, uint64_t _o)
{
	switch(step) {
		...
		(0xffaaab * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xffaaab0 + (int64_t)fr.toU64(p.y1[0][_o]) - (int64_t)fr.toU64(p.y2[0][_o]) - (int64_t)fr.toU64(p.y3[0][_o]));

		case 1: 
		return (
		(0xffaaab * (int64_t)fr.toU64(p.q2[1][_o])) +
		(0xffffff * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xffffff0 + (int64_t)fr.toU64(p.y1[1][_o]) - (int64_t)fr.toU64(p.y2[1][_o]) - (int64_t)fr.toU64(p.y3[1][_o]));
		...
		(0xffb9fe * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xffb9fe0 + (int64_t)fr.toU64(p.y1[2][_o]) - (int64_t)fr.toU64(p.y2[2][_o]) - (int64_t)fr.toU64(p.y3[2][_o]));
		...
		(0xb153ff * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xb153ff0 + (int64_t)fr.toU64(p.y1[3][_o]) - (int64_t)fr.toU64(p.y2[3][_o]) - (int64_t)fr.toU64(p.y3[3][_o]));
		...
		(0xabfffe * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xabfffe0 + (int64_t)fr.toU64(p.y1[4][_o]) - (int64_t)fr.toU64(p.y2[4][_o]) - (int64_t)fr.toU64(p.y3[4][_o]));
		...
		(0xf6241e * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xf6241e0 + (int64_t)fr.toU64(p.y1[5][_o]) - (int64_t)fr.toU64(p.y2[5][_o]) - (int64_t)fr.toU64(p.y3[5][_o]));
		...
		(0xa0f6b0 * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xa0f6b00 + (int64_t)fr.toU64(p.y1[6][_o]) - (int64_t)fr.toU64(p.y2[6][_o]) - (int64_t)fr.toU64(p.y3[6][_o]));
		...
		(0x6730d2 * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0x6730d20 + (int64_t)fr.toU64(p.y1[7][_o]) - (int64_t)fr.toU64(p.y2[7][_o]) - (int64_t)fr.toU64(p.y3[7][_o]));
		...
		(0x8512bf * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0x8512bf0 + (int64_t)fr.toU64(p.y1[8][_o]) - (int64_t)fr.toU64(p.y2[8][_o]) - (int64_t)fr.toU64(p.y3[8][_o]));
		...
		(0x4b84f3 * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0x4b84f30 + (int64_t)fr.toU64(p.y1[9][_o]) - (int64_t)fr.toU64(p.y2[9][_o]) - (int64_t)fr.toU64(p.y3[9][_o]));
		...
		(0xd76477 * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xd764770 + (int64_t)fr.toU64(p.y1[10][_o]) - (int64_t)fr.toU64(p.y2[10][_o]) - (int64_t)fr.toU64(p.y3[10][_o]));
		...
		(0x434bac * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0x434bac0 + (int64_t)fr.toU64(p.y1[11][_o]) - (int64_t)fr.toU64(p.y2[11][_o]) - (int64_t)fr.toU64(p.y3[11][_o]));
		...
		(0x1ba7b6 * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0x1ba7b60 + (int64_t)fr.toU64(p.y1[12][_o]) - (int64_t)fr.toU64(p.y2[12][_o]) - (int64_t)fr.toU64(p.y3[12][_o]));
		...
		(0xe69a4b * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xe69a4b0 + (int64_t)fr.toU64(p.y1[13][_o]) - (int64_t)fr.toU64(p.y2[13][_o]) - (int64_t)fr.toU64(p.y3[13][_o]));
		...
		(0xea397f * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0xea397f0 + (int64_t)fr.toU64(p.y1[14][_o]) - (int64_t)fr.toU64(p.y2[14][_o]) - (int64_t)fr.toU64(p.y3[14][_o]));
		...
		(0x1a0111 * (int64_t)fr.toU64(p.q2[0][_o]))
		    - 0x1a01110 + (int64_t)fr.toU64(p.y1[15][_o]) - (int64_t)fr.toU64(p.y2[15][_o]) - (int64_t)fr.toU64(p.y3[15][_o]));
