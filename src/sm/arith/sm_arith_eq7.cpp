...
int64_t eq7 (Goldilocks &fr, ArithCommitPols &p, uint64_t step, uint64_t _o)
{
	switch(step) {
		...
		( - 0xfd47   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[0][_o]) + (int64_t)fr.toU64(p.x2[0][_o]) - (int64_t)fr.toU64(p.x3[0][_o]));

		case 1: 
		return (
		( - 0xfd47   * (int64_t)fr.toU64(p.q1[1][_o])) +
		( - 0xd87c   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[1][_o]) + (int64_t)fr.toU64(p.x2[1][_o]) - (int64_t)fr.toU64(p.x3[1][_o]));
		...
		( - 0x8c16   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[2][_o]) + (int64_t)fr.toU64(p.x2[2][_o]) - (int64_t)fr.toU64(p.x3[2][_o]));
		...
		( - 0x3c20   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[3][_o]) + (int64_t)fr.toU64(p.x2[3][_o]) - (int64_t)fr.toU64(p.x3[3][_o]));
		...
		( - 0xca8d   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[4][_o]) + (int64_t)fr.toU64(p.x2[4][_o]) - (int64_t)fr.toU64(p.x3[4][_o]));
		...
		( - 0x6871   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[5][_o]) + (int64_t)fr.toU64(p.x2[5][_o]) - (int64_t)fr.toU64(p.x3[5][_o]));
		...
		( - 0xa029   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[12][_o]) + (int64_t)fr.toU64(p.x2[12][_o]) - (int64_t)fr.toU64(p.x3[12][_o]));
		...
		( - 0xe131   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[13][_o]) + (int64_t)fr.toU64(p.x2[13][_o]) - (int64_t)fr.toU64(p.x3[13][_o]));
		...
		( - 0x4e72   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[14][_o]) + (int64_t)fr.toU64(p.x2[14][_o]) - (int64_t)fr.toU64(p.x3[14][_o]));
		...
		( - 0x3064   * (int64_t)fr.toU64(p.q1[0][_o]))
		 + (int64_t)fr.toU64(p.x1[15][_o]) + (int64_t)fr.toU64(p.x2[15][_o]) - (int64_t)fr.toU64(p.x3[15][_o]));
