...
public:
    ...
    RomConstantPols (void * pAddress, uint64_t degree) :
        ...
        inRCX((Goldilocks::Element *)((uint8_t *)pAddress + 232), degree, 29),
        inCntArith((Goldilocks::Element *)((uint8_t *)pAddress + 240), degree, 30),
        inCntBinary((Goldilocks::Element *)((uint8_t *)pAddress + 248), degree, 31),
        inCntKeccakF((Goldilocks::Element *)((uint8_t *)pAddress + 256), degree, 32),
        inCntMemAlign((Goldilocks::Element *)((uint8_t *)pAddress + 264), degree, 33),
        inCntPaddingPG((Goldilocks::Element *)((uint8_t *)pAddress + 272), degree, 34),
        inCntPoseidonG((Goldilocks::Element *)((uint8_t *)pAddress + 280), degree, 35),
        incStack((Goldilocks::Element *)((uint8_t *)pAddress + 288), degree, 36),
        binOpcode((Goldilocks::Element *)((uint8_t *)pAddress + 296), degree, 37),
        jmpAddr((Goldilocks::Element *)((uint8_t *)pAddress + 304), degree, 38),
        elseAddr((Goldilocks::Element *)((uint8_t *)pAddress + 312), degree, 39),
        line((Goldilocks::Element *)((uint8_t *)pAddress + 320), degree, 40),
        operations((Goldilocks::Element *)((uint8_t *)pAddress + 328), degree, 41),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    MemAlignConstantPols (void * pAddress, uint64_t degree) :
        BYTE2A((Goldilocks::Element *)((uint8_t *)pAddress + 336), degree, 42),
        BYTE2B((Goldilocks::Element *)((uint8_t *)pAddress + 344), degree, 43),
        BYTE_C4096((Goldilocks::Element *)((uint8_t *)pAddress + 352), degree, 44),
        FACTOR{
        ...
        FACTORV{
            ...
            ConstantPol((Goldilocks::Element *)((uint8_t *)pAddress + 464), degree, 58),
            ConstantPol((Goldilocks::Element *)((uint8_t *)pAddress + 472), degree, 59),
            ConstantPol((Goldilocks::Element *)((uint8_t *)pAddress + 480), degree, 60)
        },
        STEP((Goldilocks::Element *)((uint8_t *)pAddress + 488), degree, 61),
        WR256((Goldilocks::Element *)((uint8_t *)pAddress + 496), degree, 62),
        WR8((Goldilocks::Element *)((uint8_t *)pAddress + 504), degree, 63),
        OFFSET((Goldilocks::Element *)((uint8_t *)pAddress + 512), degree, 64),
        RESET((Goldilocks::Element *)((uint8_t *)pAddress + 520), degree, 65),
        SELM1((Goldilocks::Element *)((uint8_t *)pAddress + 528), degree, 66),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    ArithConstantPols (void * pAddress, uint64_t degree) :
        BYTE2_BIT19((Goldilocks::Element *)((uint8_t *)pAddress + 536), degree, 67),
        SEL_BYTE2_BIT19((Goldilocks::Element *)((uint8_t *)pAddress + 544), degree, 68),
        GL_SIGNED_22BITS((Goldilocks::Element *)((uint8_t *)pAddress + 552), degree, 69),
        CLK{
...
public:
    ...
    BinaryConstantPols (void * pAddress, uint64_t degree) :
        P_OPCODE((Goldilocks::Element *)((uint8_t *)pAddress + 816), degree, 102),
        P_A((Goldilocks::Element *)((uint8_t *)pAddress + 824), degree, 103),
        P_B((Goldilocks::Element *)((uint8_t *)pAddress + 832), degree, 104),
        P_CIN((Goldilocks::Element *)((uint8_t *)pAddress + 840), degree, 105),
        P_LAST((Goldilocks::Element *)((uint8_t *)pAddress + 848), degree, 106),
        P_USE_CARRY((Goldilocks::Element *)((uint8_t *)pAddress + 856), degree, 107),
        P_C((Goldilocks::Element *)((uint8_t *)pAddress + 864), degree, 108),
        P_COUT((Goldilocks::Element *)((uint8_t *)pAddress + 872), degree, 109),
        RESET((Goldilocks::Element *)((uint8_t *)pAddress + 880), degree, 110),
        FACTOR{
...
public:
    ...
    PoseidonGConstantPols (void * pAddress, uint64_t degree) :
        LAST((Goldilocks::Element *)((uint8_t *)pAddress + 952), degree, 119),
        LATCH((Goldilocks::Element *)((uint8_t *)pAddress + 960), degree, 120),
        LASTBLOCK((Goldilocks::Element *)((uint8_t *)pAddress + 968), degree, 121),
        PARTIAL((Goldilocks::Element *)((uint8_t *)pAddress + 976), degree, 122),
        C{
...
public:
    ...
    PaddingPGConstantPols (void * pAddress, uint64_t degree) :
        ...
        lastBlock((Goldilocks::Element *)((uint8_t *)pAddress + 1144), degree, 143),
        k_crOffset((Goldilocks::Element *)((uint8_t *)pAddress + 1152), degree, 144),
        k_crF0((Goldilocks::Element *)((uint8_t *)pAddress + 1160), degree, 145),
        k_crF1((Goldilocks::Element *)((uint8_t *)pAddress + 1168), degree, 146),
        k_crF2((Goldilocks::Element *)((uint8_t *)pAddress + 1176), degree, 147),
        k_crF3((Goldilocks::Element *)((uint8_t *)pAddress + 1184), degree, 148),
        k_crF4((Goldilocks::Element *)((uint8_t *)pAddress + 1192), degree, 149),
        k_crF5((Goldilocks::Element *)((uint8_t *)pAddress + 1200), degree, 150),
        k_crF6((Goldilocks::Element *)((uint8_t *)pAddress + 1208), degree, 151),
        k_crF7((Goldilocks::Element *)((uint8_t *)pAddress + 1216), degree, 152),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    StorageConstantPols (void * pAddress, uint64_t degree) :
        rHash((Goldilocks::Element *)((uint8_t *)pAddress + 1224), degree, 153),
        rHashType((Goldilocks::Element *)((uint8_t *)pAddress + 1232), degree, 154),
        rLatchGet((Goldilocks::Element *)((uint8_t *)pAddress + 1240), degree, 155),
        rLatchSet((Goldilocks::Element *)((uint8_t *)pAddress + 1248), degree, 156),
        rClimbRkey((Goldilocks::Element *)((uint8_t *)pAddress + 1256), degree, 157),
        rClimbSiblingRkey((Goldilocks::Element *)((uint8_t *)pAddress + 1264), degree, 158),
        rClimbSiblingRkeyN((Goldilocks::Element *)((uint8_t *)pAddress + 1272), degree, 159),
        rRotateLevel((Goldilocks::Element *)((uint8_t *)pAddress + 1280), degree, 160),
        rJmpz((Goldilocks::Element *)((uint8_t *)pAddress + 1288), degree, 161),
        rJmp((Goldilocks::Element *)((uint8_t *)pAddress + 1296), degree, 162),
        rConst0((Goldilocks::Element *)((uint8_t *)pAddress + 1304), degree, 163),
        rConst1((Goldilocks::Element *)((uint8_t *)pAddress + 1312), degree, 164),
        rConst2((Goldilocks::Element *)((uint8_t *)pAddress + 1320), degree, 165),
        rConst3((Goldilocks::Element *)((uint8_t *)pAddress + 1328), degree, 166),
        rAddress((Goldilocks::Element *)((uint8_t *)pAddress + 1336), degree, 167),
        rLine((Goldilocks::Element *)((uint8_t *)pAddress + 1344), degree, 168),
        rInFree((Goldilocks::Element *)((uint8_t *)pAddress + 1352), degree, 169),
        rInNewRoot((Goldilocks::Element *)((uint8_t *)pAddress + 1360), degree, 170),
        rInOldRoot((Goldilocks::Element *)((uint8_t *)pAddress + 1368), degree, 171),
        rInRkey((Goldilocks::Element *)((uint8_t *)pAddress + 1376), degree, 172),
        rInRkeyBit((Goldilocks::Element *)((uint8_t *)pAddress + 1384), degree, 173),
        rInSiblingRkey((Goldilocks::Element *)((uint8_t *)pAddress + 1392), degree, 174),
        rInSiblingValueHash((Goldilocks::Element *)((uint8_t *)pAddress + 1400), degree, 175),
...
public:
    ...
    PaddingKKBitConstantPols (void * pAddress, uint64_t degree) :
        ...
        ConnNine2OneBit((Goldilocks::Element *)((uint8_t *)pAddress + 1704), degree, 213),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    PaddingKKConstantPols (void * pAddress, uint64_t degree) :
        ...
        k_crOffset((Goldilocks::Element *)((uint8_t *)pAddress + 1760), degree, 220),
        k_crF0((Goldilocks::Element *)((uint8_t *)pAddress + 1768), degree, 221),
        k_crF1((Goldilocks::Element *)((uint8_t *)pAddress + 1776), degree, 222),
        k_crF2((Goldilocks::Element *)((uint8_t *)pAddress + 1784), degree, 223),
        k_crF3((Goldilocks::Element *)((uint8_t *)pAddress + 1792), degree, 224),
        k_crF4((Goldilocks::Element *)((uint8_t *)pAddress + 1800), degree, 225),
        k_crF5((Goldilocks::Element *)((uint8_t *)pAddress + 1808), degree, 226),
        k_crF6((Goldilocks::Element *)((uint8_t *)pAddress + 1816), degree, 227),
        k_crF7((Goldilocks::Element *)((uint8_t *)pAddress + 1824), degree, 228),
        crValid((Goldilocks::Element *)((uint8_t *)pAddress + 1832), degree, 229),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    MemConstantPols (void * pAddress, uint64_t degree) :
        INCS((Goldilocks::Element *)((uint8_t *)pAddress + 1840), degree, 230),
        ISNOTLAST((Goldilocks::Element *)((uint8_t *)pAddress + 1848), degree, 231),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    MainConstantPols (void * pAddress, uint64_t degree) :
        STEP((Goldilocks::Element *)((uint8_t *)pAddress + 1856), degree, 232),
        _pAddress(pAddress),
        _degree(degree) {};
