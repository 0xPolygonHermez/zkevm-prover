...
public:
    ...
    inline Goldilocks::Element & operator[](uint64_t i) { return _pAddress[i*231]; };
...
public:
    ...
    RomConstantPols (void * pAddress, uint64_t degree) :
        ...
        line((Goldilocks::Element *)((uint8_t *)pAddress + 304), degree, 38),
        operations((Goldilocks::Element *)((uint8_t *)pAddress + 312), degree, 39),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    MemAlignConstantPols (void * pAddress, uint64_t degree) :
        BYTE2A((Goldilocks::Element *)((uint8_t *)pAddress + 320), degree, 40),
        BYTE2B((Goldilocks::Element *)((uint8_t *)pAddress + 328), degree, 41),
        BYTE_C4096((Goldilocks::Element *)((uint8_t *)pAddress + 336), degree, 42),
        FACTOR{
        ...
        STEP((Goldilocks::Element *)((uint8_t *)pAddress + 472), degree, 59),
        WR256((Goldilocks::Element *)((uint8_t *)pAddress + 480), degree, 60),
        WR8((Goldilocks::Element *)((uint8_t *)pAddress + 488), degree, 61),
        OFFSET((Goldilocks::Element *)((uint8_t *)pAddress + 496), degree, 62),
        RESET((Goldilocks::Element *)((uint8_t *)pAddress + 504), degree, 63),
        SELM1((Goldilocks::Element *)((uint8_t *)pAddress + 512), degree, 64),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    ArithConstantPols (void * pAddress, uint64_t degree) :
        BYTE2_BIT19((Goldilocks::Element *)((uint8_t *)pAddress + 520), degree, 65),
        SEL_BYTE2_BIT19((Goldilocks::Element *)((uint8_t *)pAddress + 528), degree, 66),
        GL_SIGNED_22BITS((Goldilocks::Element *)((uint8_t *)pAddress + 536), degree, 67),
        CLK{
...
public:
    ...
    BinaryConstantPols (void * pAddress, uint64_t degree) :
        P_OPCODE((Goldilocks::Element *)((uint8_t *)pAddress + 800), degree, 100),
        P_A((Goldilocks::Element *)((uint8_t *)pAddress + 808), degree, 101),
        P_B((Goldilocks::Element *)((uint8_t *)pAddress + 816), degree, 102),
        P_CIN((Goldilocks::Element *)((uint8_t *)pAddress + 824), degree, 103),
        P_LAST((Goldilocks::Element *)((uint8_t *)pAddress + 832), degree, 104),
        P_USE_CARRY((Goldilocks::Element *)((uint8_t *)pAddress + 840), degree, 105),
        P_C((Goldilocks::Element *)((uint8_t *)pAddress + 848), degree, 106),
        P_COUT((Goldilocks::Element *)((uint8_t *)pAddress + 856), degree, 107),
        RESET((Goldilocks::Element *)((uint8_t *)pAddress + 864), degree, 108),
        FACTOR{
...
public:
    ...
    PoseidonGConstantPols (void * pAddress, uint64_t degree) :
        LAST((Goldilocks::Element *)((uint8_t *)pAddress + 936), degree, 117),
        LATCH((Goldilocks::Element *)((uint8_t *)pAddress + 944), degree, 118),
        LASTBLOCK((Goldilocks::Element *)((uint8_t *)pAddress + 952), degree, 119),
        PARTIAL((Goldilocks::Element *)((uint8_t *)pAddress + 960), degree, 120),
        C{
...
public:
    ...
    PaddingPGConstantPols (void * pAddress, uint64_t degree) :
        ...
        lastBlock((Goldilocks::Element *)((uint8_t *)pAddress + 1128), degree, 141),
        k_crOffset((Goldilocks::Element *)((uint8_t *)pAddress + 1136), degree, 142),
        k_crF0((Goldilocks::Element *)((uint8_t *)pAddress + 1144), degree, 143),
        k_crF1((Goldilocks::Element *)((uint8_t *)pAddress + 1152), degree, 144),
        k_crF2((Goldilocks::Element *)((uint8_t *)pAddress + 1160), degree, 145),
        k_crF3((Goldilocks::Element *)((uint8_t *)pAddress + 1168), degree, 146),
        k_crF4((Goldilocks::Element *)((uint8_t *)pAddress + 1176), degree, 147),
        k_crF5((Goldilocks::Element *)((uint8_t *)pAddress + 1184), degree, 148),
        k_crF6((Goldilocks::Element *)((uint8_t *)pAddress + 1192), degree, 149),
        k_crF7((Goldilocks::Element *)((uint8_t *)pAddress + 1200), degree, 150),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    StorageConstantPols (void * pAddress, uint64_t degree) :
        rHash((Goldilocks::Element *)((uint8_t *)pAddress + 1208), degree, 151),
        rHashType((Goldilocks::Element *)((uint8_t *)pAddress + 1216), degree, 152),
        rLatchGet((Goldilocks::Element *)((uint8_t *)pAddress + 1224), degree, 153),
        rLatchSet((Goldilocks::Element *)((uint8_t *)pAddress + 1232), degree, 154),
        rClimbRkey((Goldilocks::Element *)((uint8_t *)pAddress + 1240), degree, 155),
        rClimbSiblingRkey((Goldilocks::Element *)((uint8_t *)pAddress + 1248), degree, 156),
        rClimbSiblingRkeyN((Goldilocks::Element *)((uint8_t *)pAddress + 1256), degree, 157),
        rRotateLevel((Goldilocks::Element *)((uint8_t *)pAddress + 1264), degree, 158),
        rJmpz((Goldilocks::Element *)((uint8_t *)pAddress + 1272), degree, 159),
        rJmp((Goldilocks::Element *)((uint8_t *)pAddress + 1280), degree, 160),
        rConst0((Goldilocks::Element *)((uint8_t *)pAddress + 1288), degree, 161),
        rConst1((Goldilocks::Element *)((uint8_t *)pAddress + 1296), degree, 162),
        rConst2((Goldilocks::Element *)((uint8_t *)pAddress + 1304), degree, 163),
        rConst3((Goldilocks::Element *)((uint8_t *)pAddress + 1312), degree, 164),
        rAddress((Goldilocks::Element *)((uint8_t *)pAddress + 1320), degree, 165),
        rLine((Goldilocks::Element *)((uint8_t *)pAddress + 1328), degree, 166),
        rInFree((Goldilocks::Element *)((uint8_t *)pAddress + 1336), degree, 167),
        rInNewRoot((Goldilocks::Element *)((uint8_t *)pAddress + 1344), degree, 168),
        rInOldRoot((Goldilocks::Element *)((uint8_t *)pAddress + 1352), degree, 169),
        rInRkey((Goldilocks::Element *)((uint8_t *)pAddress + 1360), degree, 170),
        rInRkeyBit((Goldilocks::Element *)((uint8_t *)pAddress + 1368), degree, 171),
        rInSiblingRkey((Goldilocks::Element *)((uint8_t *)pAddress + 1376), degree, 172),
        rInSiblingValueHash((Goldilocks::Element *)((uint8_t *)pAddress + 1384), degree, 173),
...
public:
    ...
    PaddingKKBitConstantPols (void * pAddress, uint64_t degree) :
        ...
        ConnNine2OneBit((Goldilocks::Element *)((uint8_t *)pAddress + 1688), degree, 211),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    PaddingKKConstantPols (void * pAddress, uint64_t degree) :
        ...
        k_crOffset((Goldilocks::Element *)((uint8_t *)pAddress + 1744), degree, 218),
        k_crF0((Goldilocks::Element *)((uint8_t *)pAddress + 1752), degree, 219),
        k_crF1((Goldilocks::Element *)((uint8_t *)pAddress + 1760), degree, 220),
        k_crF2((Goldilocks::Element *)((uint8_t *)pAddress + 1768), degree, 221),
        k_crF3((Goldilocks::Element *)((uint8_t *)pAddress + 1776), degree, 222),
        k_crF4((Goldilocks::Element *)((uint8_t *)pAddress + 1784), degree, 223),
        k_crF5((Goldilocks::Element *)((uint8_t *)pAddress + 1792), degree, 224),
        k_crF6((Goldilocks::Element *)((uint8_t *)pAddress + 1800), degree, 225),
        k_crF7((Goldilocks::Element *)((uint8_t *)pAddress + 1808), degree, 226),
        crValid((Goldilocks::Element *)((uint8_t *)pAddress + 1816), degree, 227),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    MemConstantPols (void * pAddress, uint64_t degree) :
        INCS((Goldilocks::Element *)((uint8_t *)pAddress + 1824), degree, 228),
        ISNOTLAST((Goldilocks::Element *)((uint8_t *)pAddress + 1832), degree, 229),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    MainConstantPols (void * pAddress, uint64_t degree) :
        STEP((Goldilocks::Element *)((uint8_t *)pAddress + 1840), degree, 230),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    inline static uint64_t pilSize (void) { return 15502147584; }
    inline static uint64_t pilDegree (void) { return 8388608; }
    inline static uint64_t numPols (void) { return 231; }

    inline void * address (void) { return _pAddress; }
    inline uint64_t degree (void) { return _degree; }
    inline uint64_t size (void) { return _degree*231*sizeof(Goldilocks::Element); }
