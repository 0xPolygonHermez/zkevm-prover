...
public:
    ...
    Goldilocks::Element & operator[](uint64_t i) { return _pAddress[i*275]; };
...
public:
    ...
    NormGate9ConstantPols (void * pAddress, uint64_t degree) :
        Value3((Goldilocks::Element *)((uint8_t *)pAddress + 1792), degree, 224),
        Value3Norm((Goldilocks::Element *)((uint8_t *)pAddress + 1800), degree, 225),
        Gate9Type((Goldilocks::Element *)((uint8_t *)pAddress + 1808), degree, 226),
        Gate9A((Goldilocks::Element *)((uint8_t *)pAddress + 1816), degree, 227),
        Gate9B((Goldilocks::Element *)((uint8_t *)pAddress + 1824), degree, 228),
        Gate9C((Goldilocks::Element *)((uint8_t *)pAddress + 1832), degree, 229),
        Latch((Goldilocks::Element *)((uint8_t *)pAddress + 1840), degree, 230),
...
public:
    ...
    KeccakFConstantPols (void * pAddress, uint64_t degree) :
        ConnA((Goldilocks::Element *)((uint8_t *)pAddress + 1856), degree, 232),
        ConnB((Goldilocks::Element *)((uint8_t *)pAddress + 1864), degree, 233),
        ConnC((Goldilocks::Element *)((uint8_t *)pAddress + 1872), degree, 234),
        NormalizedGate((Goldilocks::Element *)((uint8_t *)pAddress + 1880), degree, 235),
        GateType((Goldilocks::Element *)((uint8_t *)pAddress + 1888), degree, 236),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    Nine2OneConstantPols (void * pAddress, uint64_t degree) :
        Field9latch((Goldilocks::Element *)((uint8_t *)pAddress + 1896), degree, 237),
        Factor((Goldilocks::Element *)((uint8_t *)pAddress + 1904), degree, 238),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    PaddingKKBitConstantPols (void * pAddress, uint64_t degree) :
        r8Id((Goldilocks::Element *)((uint8_t *)pAddress + 1912), degree, 239),
        sOutId((Goldilocks::Element *)((uint8_t *)pAddress + 1920), degree, 240),
        latchR8((Goldilocks::Element *)((uint8_t *)pAddress + 1928), degree, 241),
        Fr8((Goldilocks::Element *)((uint8_t *)pAddress + 1936), degree, 242),
        rBitValid((Goldilocks::Element *)((uint8_t *)pAddress + 1944), degree, 243),
        latchSOut((Goldilocks::Element *)((uint8_t *)pAddress + 1952), degree, 244),
        FSOut0((Goldilocks::Element *)((uint8_t *)pAddress + 1960), degree, 245),
        FSOut1((Goldilocks::Element *)((uint8_t *)pAddress + 1968), degree, 246),
        FSOut2((Goldilocks::Element *)((uint8_t *)pAddress + 1976), degree, 247),
        FSOut3((Goldilocks::Element *)((uint8_t *)pAddress + 1984), degree, 248),
        FSOut4((Goldilocks::Element *)((uint8_t *)pAddress + 1992), degree, 249),
        FSOut5((Goldilocks::Element *)((uint8_t *)pAddress + 2000), degree, 250),
        FSOut6((Goldilocks::Element *)((uint8_t *)pAddress + 2008), degree, 251),
        FSOut7((Goldilocks::Element *)((uint8_t *)pAddress + 2016), degree, 252),
        ConnSOutBit((Goldilocks::Element *)((uint8_t *)pAddress + 2024), degree, 253),
        ConnSInBit((Goldilocks::Element *)((uint8_t *)pAddress + 2032), degree, 254),
        ConnNine2OneBit((Goldilocks::Element *)((uint8_t *)pAddress + 2040), degree, 255),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    PaddingKKConstantPols (void * pAddress, uint64_t degree) :
        r8Id((Goldilocks::Element *)((uint8_t *)pAddress + 2048), degree, 256),
        lastBlock((Goldilocks::Element *)((uint8_t *)pAddress + 2056), degree, 257),
        lastBlockLatch((Goldilocks::Element *)((uint8_t *)pAddress + 2064), degree, 258),
        r8valid((Goldilocks::Element *)((uint8_t *)pAddress + 2072), degree, 259),
        sOutId((Goldilocks::Element *)((uint8_t *)pAddress + 2080), degree, 260),
        forceLastHash((Goldilocks::Element *)((uint8_t *)pAddress + 2088), degree, 261),
        k_crOffset((Goldilocks::Element *)((uint8_t *)pAddress + 2096), degree, 262),
        k_crF0((Goldilocks::Element *)((uint8_t *)pAddress + 2104), degree, 263),
        k_crF1((Goldilocks::Element *)((uint8_t *)pAddress + 2112), degree, 264),
        k_crF2((Goldilocks::Element *)((uint8_t *)pAddress + 2120), degree, 265),
        k_crF3((Goldilocks::Element *)((uint8_t *)pAddress + 2128), degree, 266),
        k_crF4((Goldilocks::Element *)((uint8_t *)pAddress + 2136), degree, 267),
        k_crF5((Goldilocks::Element *)((uint8_t *)pAddress + 2144), degree, 268),
        k_crF6((Goldilocks::Element *)((uint8_t *)pAddress + 2152), degree, 269),
        k_crF7((Goldilocks::Element *)((uint8_t *)pAddress + 2160), degree, 270),
        crValid((Goldilocks::Element *)((uint8_t *)pAddress + 2168), degree, 271),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    MemConstantPols (void * pAddress, uint64_t degree) :
        INCS((Goldilocks::Element *)((uint8_t *)pAddress + 2176), degree, 272),
        ISNOTLAST((Goldilocks::Element *)((uint8_t *)pAddress + 2184), degree, 273),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    MainConstantPols (void * pAddress, uint64_t degree) :
        STEP((Goldilocks::Element *)((uint8_t *)pAddress + 2192), degree, 274),
        _pAddress(pAddress),
        _degree(degree) {};
...
public:
    ...
    static uint64_t pilSize (void) { return 18454937600; }
    static uint64_t pilDegree (void) { return 8388608; }
    static uint64_t numPols (void) { return 275; }

    void * address (void) { return _pAddress; }
    uint64_t degree (void) { return _degree; }
    uint64_t size (void) { return _degree*275*sizeof(Goldilocks::Element); }
