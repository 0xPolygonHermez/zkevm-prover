        ...
        for (uint64_t i = 0; i < domainSize; i+= nrowsPack) {
            ...
            for (uint64_t kk = 0; kk < parserParams.nOps; ++kk) {
                ...
                case 12: {
                    ...
                    Goldilocks::copy_avx(bufferT_[nColsStagesAcc[args[i_args]] + args[i_args + 1]], tmp1_0);
                    setStorePol(storePol, args[i_args], args[i_args + 1], 1);
                    i_args += 2;
                    break;
                }
                ...
                case 33: {
                    ...
                    Goldilocks3::op_31_avx(args[i_args], (Goldilocks3::Element_avx &)bufferT_[nColsStagesAcc[args[i_args + 1]] + args[i_args + 2]], (Goldilocks3::Element_avx &)bufferT_[nColsStagesAcc[args[i_args + 3]] + args[i_args + 4]], tmp1_1);
                    setStorePol(storePol, args[i_args + 1], args[i_args + 2], FIELD_EXTENSION);
                    i_args += 5;
                    break;
                }
                ...
                case 38: {
                    ...
                    Goldilocks::load_avx(tmp1_1, x[i], x.offset());
                    Goldilocks3::op_31_avx(args[i_args], (Goldilocks3::Element_avx &)bufferT_[nColsStagesAcc[args[i_args + 1]] + args[i_args + 2]], tmp3[args[i_args + 3]], tmp1_1);
                    setStorePol(storePol, args[i_args + 1], args[i_args + 2], FIELD_EXTENSION);
                    i_args += 4;
                    break;
                }
                ...
                case 43: {
                    ...
                    Goldilocks::load_avx(tmp1_1, x[i], x.offset());
                    Goldilocks3::op_31_avx(args[i_args], (Goldilocks3::Element_avx &)bufferT_[nColsStagesAcc[args[i_args + 1]] + args[i_args + 2]], challenges[args[i_args + 3]], tmp1_1);
                    setStorePol(storePol, args[i_args + 1], args[i_args + 2], FIELD_EXTENSION);
                    i_args += 4;
                    break;
                }
                ...
                case 59: {
                    ...
                    Goldilocks::load_avx(tmp1_1, x[i], x.offset());
                    Goldilocks3::op_31_avx(args[i_args], tmp3[args[i_args + 1]], (Goldilocks3::Element_avx &)bufferT_[nColsStagesAcc[args[i_args + 2]] + args[i_args + 3]], tmp1_1);
                    i_args += 4;
                    break;
                }
                case 60: {
