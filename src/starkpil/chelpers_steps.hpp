        ...
        for (uint64_t i = 0; i < domainSize; i+= nrowsPack) {
            ...
            for (uint64_t kk = 0; kk < parserParams.nOps; ++kk) {
                ...
                case 0: {
                    ...
                    Goldilocks::copy_avx(bufferT_[buffTOffsetsStages[args[i_args]] + 2 * args[i_args + 1] + args[i_args + 2]], bufferT_[buffTOffsetsStages[args[i_args + 3]] + 2 * args[i_args + 4] + args[i_args + 5]]);
                ...
                case 1: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], bufferT_[buffTOffsetsStages[args[i_args + 4]] + 2 * args[i_args + 5] + args[i_args + 6]], bufferT_[buffTOffsetsStages[args[i_args + 7]] + 2 * args[i_args + 8] + args[i_args + 9]]);
                ...
                case 2: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], bufferT_[buffTOffsetsStages[args[i_args + 4]] + 2 * args[i_args + 5] + args[i_args + 6]], tmp1[args[i_args + 7]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 8;
                    break;
                }
                case 3: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], bufferT_[buffTOffsetsStages[args[i_args + 4]] + 2 * args[i_args + 5] + args[i_args + 6]], publics[args[i_args + 7]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 8;
                    break;
                }
                case 4: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], bufferT_[buffTOffsetsStages[args[i_args + 4]] + 2 * args[i_args + 5] + args[i_args + 6]], numbers_[args[i_args + 7]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 8;
                    break;
                }
                case 5: {
                    ...
                    Goldilocks::copy_avx(bufferT_[buffTOffsetsStages[args[i_args]] + 2 * args[i_args + 1] + args[i_args + 2]], tmp1[args[i_args + 3]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args], args[i_args + 1], args[i_args + 2], 1);
                    i_args += 4;
                    break;
                }
                case 6: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], tmp1[args[i_args + 4]], tmp1[args[i_args + 5]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 6;
                    break;
                }
                case 7: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], tmp1[args[i_args + 4]], publics[args[i_args + 5]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 6;
                    break;
                }
                case 8: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], tmp1[args[i_args + 4]], numbers_[args[i_args + 5]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 6;
                    break;
                }
                case 9: {
                    ...
                    Goldilocks::copy_avx(bufferT_[buffTOffsetsStages[args[i_args]] + 2 * args[i_args + 1] + args[i_args + 2]], publics[args[i_args + 3]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args], args[i_args + 1], args[i_args + 2], 1);
                    i_args += 4;
                    break;
                }
                case 10: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], publics[args[i_args + 4]], publics[args[i_args + 5]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 6;
                    break;
                }
                case 11: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], publics[args[i_args + 4]], numbers_[args[i_args + 5]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 6;
                    break;
                }
                case 12: {
                    ...
                    Goldilocks::copy_avx(bufferT_[buffTOffsetsStages[args[i_args]] + 2 * args[i_args + 1] + args[i_args + 2]], tmp1_0);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args], args[i_args + 1], args[i_args + 2], 1);
                    i_args += 3;
                    break;
                }
                case 13: {
                    ...
                    Goldilocks::copy_avx(bufferT_[buffTOffsetsStages[args[i_args]] + 2 * args[i_args + 1] + args[i_args + 2]], numbers_[args[i_args + 3]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args], args[i_args + 1], args[i_args + 2], 1);
                    i_args += 4;
                    break;
                }
                case 14: {
                    ...
                    Goldilocks::op_avx(args[i_args], bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], numbers_[args[i_args + 4]], numbers_[args[i_args + 5]]);
                    setStorePol(storePol, buffTOffsetsStages, args[i_args + 1], args[i_args + 2], args[i_args + 3], 1);
                    i_args += 6;
                    break;
                }
                ...
                case 30: {
                    ...
                    Goldilocks3::op_31_avx(args[i_args], &bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], 2, 
                ...
                case 45: {
                    ...
                    Goldilocks3::copy_avx(&bufferT_[buffTOffsetsStages[args[i_args]] + 2 * args[i_args + 1] + args[i_args + 2]], 2, 
                ...
                case 48: {
                    ...
                    Goldilocks3::mul_avx(&bufferT_[buffTOffsetsStages[args[i_args + 1]] + 2 * args[i_args + 2] + args[i_args + 3]], 2, 
                        &bufferT_[buffTOffsetsStages[args[i_args + 4]] + 2 * args[i_args + 5] + args[i_args + 6]], 2, 
