...
public:
    ...
    static void fold(uint64_t step, FRIProof<ElementType> &proof, Goldilocks::Element *pol, Polinomial& challenge, StarkInfo starkInfo, MerkleTreeType** treesFRI);
...
private:
    ...
    static void evalPol(Goldilocks::Element* res, uint64_t res_idx, uint64_t degree, Goldilocks::Element* p, Polinomial &x);
