...
public:
    ...
    CompressorCommitPolsC12 (void * pAddress, uint64_t degree) :
        a{
...
{
public:
    CompressorCommitPolsC12 Compressor;
private:
    void * _pAddress;
    uint64_t _degree;
public:

    CommitPolsC12 (void * pAddress, uint64_t degree) :
