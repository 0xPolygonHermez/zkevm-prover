...
public:
    ...
    ordered_json ProofTree2json()
    {
        ...
        {
            json_root.push_back(RawFr::field.toString(root[i]));
        }
        // if (RawFr::field.toU64(root[0]) != 0 && RawFr::field.toU64(root[1]) != 0 && RawFr::field.toU64(root[2]) != 0 && RawFr::field.toU64(root[3]) != 0)
