...
;comparison
    test r12,r12
jnz FrG_rawFromMontgomery_sq
    cmp r11,[q + 0]
    jc FrG_rawFromMontgomery_done
    jnz FrG_rawFromMontgomery_sq
FrG_rawFromMontgomery_sq:
    sub r11,[q +0]
FrG_rawFromMontgomery_done:
    mov [rdi + 0],r11
    pop r12
    pop r13
    ret
