...
void Starks::genProof(FRIProof &proof, Goldilocks::Element *publicInputs, Goldilocks::Element verkey[4], CHelpersSteps *chelpersSteps)
{
    ...
    chelpersSteps->genAST = true;
    chelpersSteps->fileAST = "plookups_h1h2.json";
...
#pragma omp parallel for num_threads(nthreads)
    ...
    chelpersSteps->fileAST = "z_polynomials.json";
...
#pragma omp parallel for
    ...
    chelpersSteps->fileAST = "q_polynomial.json";
...
#pragma omp parallel for
    ...
    chelpersSteps->fileAST = "fri_polynomial.json";
