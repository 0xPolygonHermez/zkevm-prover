...
public:
    ...
    GlobalConstantPolsBasicC12a (void * pAddress, uint64_t degree) :
...
public:
    ...
    CompressorConstantPolsBasicC12 (void * pAddress, uint64_t degree) :
        S{
            ConstantPolBasicC12a((Goldilocks::Element *)((uint8_t *)pAddress + 8), degree, 1),
            ConstantPolBasicC12a((Goldilocks::Element *)((uint8_t *)pAddress + 16), degree, 2),
            ConstantPolBasicC12a((Goldilocks::Element *)((uint8_t *)pAddress + 24), degree, 3),
