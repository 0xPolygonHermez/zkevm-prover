#ifndef STARK_C12_MOCK_HPP
#define STARK_C12_MOCK_HPP

#include "stark_info.hpp"
#include "commit_pols_basic_C12.hpp"
#include "constant_pols_basic_C12.hpp"
...
public:
    StarkC12Mock(const Config &config);
    ~StarkC12Mock();
