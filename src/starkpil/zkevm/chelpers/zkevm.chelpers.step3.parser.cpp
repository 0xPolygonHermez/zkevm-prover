     ...
     for (uint64_t i = 0; i < nrows; i += nrowsBatch)
     {
          ...
          for (int kk = 0; kk < NOPS_; ++kk)
          {
               ...
               case 0:
               {
                    ...
                    // Goldilocks::store(var, tmp1[(args3[i_args])]);
                    // std::cout << kk << " " << op3[kk] << " " << Goldilocks::toU64(var[0]) << std::endl;
                    i_args += 3;
                    break;
               }
               case 1:
               ...
               case 12:
               {
                    ...
                    // Goldilocks::store(var, tmp3[args3[i_args]][0]);
                    //  std::cout << kk << " " << op3[kk] << " " << Goldilocks::toU64(var[0]) << std::endl;
               ...
               case 86:
               {
                    ...
                    // std::cout << kk << " " << op3[kk] << " " << Goldilocks::toU64(params.pols[args3[i_args] + i * args3[i_args + 1]]) << std::endl;
                    i_args += 4;
                    break;
               }
               case 87:
               ...
               case 101:
               {
                    ...
                    // std::cout << kk << " " << op3[kk] << " " << Goldilocks::toU64(params.pols[args3[i_args] + ((i + args3[i_args + 1]) % args3[i_args + 2]) * args3[i_args + 3]]) << std::endl;
