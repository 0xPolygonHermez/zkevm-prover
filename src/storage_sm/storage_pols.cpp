...
void StoragePols::alloc (uint64_t len)
{
    ...
    VALUE_LOW0 = (FieldElement*)(pAddress + 18*length);
    VALUE_LOW1 = (FieldElement*)(pAddress + 19*length);
    VALUE_LOW2 = (FieldElement*)(pAddress + 20*length);
    VALUE_LOW3 = (FieldElement*)(pAddress + 21*length);
    VALUE_HIGH0 = (FieldElement*)(pAddress + 22*length);
    VALUE_HIGH1 = (FieldElement*)(pAddress + 23*length);
    VALUE_HIGH2 = (FieldElement*)(pAddress + 24*length);
    VALUE_HIGH3 = (FieldElement*)(pAddress + 25*length);
