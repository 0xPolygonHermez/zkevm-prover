...
{
    cout << "Registers:" << endl;
    printU32(ctx, "A7", ctx.pols.A7[ctx.step]);
    printU32(ctx, "A6", ctx.pols.A6[ctx.step]);
    printU32(ctx, "A5", ctx.pols.A5[ctx.step]);
    printU32(ctx, "A4", ctx.pols.A4[ctx.step]);
    printU32(ctx, "A3", ctx.pols.A3[ctx.step]);
    printU32(ctx, "A2", ctx.pols.A2[ctx.step]);
    printU32(ctx, "A1", ctx.pols.A1[ctx.step]);
    printReg(ctx, "A0", ctx.pols.A0[ctx.step]);
    printU32(ctx, "B7", ctx.pols.B7[ctx.step]);
    printU32(ctx, "B6", ctx.pols.B6[ctx.step]);
    printU32(ctx, "B5", ctx.pols.B5[ctx.step]);
    printU32(ctx, "B4", ctx.pols.B4[ctx.step]);
    printU32(ctx, "B3", ctx.pols.B3[ctx.step]);
    printU32(ctx, "B2", ctx.pols.B2[ctx.step]);
    printU32(ctx, "B1", ctx.pols.B1[ctx.step]);
    printReg(ctx, "B0", ctx.pols.B0[ctx.step]);
    printU32(ctx, "C7", ctx.pols.C7[ctx.step]);
    printU32(ctx, "C6", ctx.pols.C6[ctx.step]);
    printU32(ctx, "C5", ctx.pols.C5[ctx.step]);
    printU32(ctx, "C4", ctx.pols.C4[ctx.step]);
    printU32(ctx, "C3", ctx.pols.C3[ctx.step]);
    printU32(ctx, "C2", ctx.pols.C2[ctx.step]);
    printU32(ctx, "C1", ctx.pols.C1[ctx.step]);
    printReg(ctx, "C0", ctx.pols.C0[ctx.step]);
    printU32(ctx, "D7", ctx.pols.D7[ctx.step]);
    printU32(ctx, "D6", ctx.pols.D6[ctx.step]);
    printU32(ctx, "D5", ctx.pols.D5[ctx.step]);
    printU32(ctx, "D4", ctx.pols.D4[ctx.step]);
    printU32(ctx, "D3", ctx.pols.D3[ctx.step]);
    printU32(ctx, "D2", ctx.pols.D2[ctx.step]);
    printU32(ctx, "D1", ctx.pols.D1[ctx.step]);
    printReg(ctx, "D0", ctx.pols.D0[ctx.step]);
    printU32(ctx, "E7", ctx.pols.E7[ctx.step]);
    printU32(ctx, "E6", ctx.pols.E6[ctx.step]);
    printU32(ctx, "E5", ctx.pols.E5[ctx.step]);
    printU32(ctx, "E4", ctx.pols.E4[ctx.step]);
    printU32(ctx, "E3", ctx.pols.E3[ctx.step]);
    printU32(ctx, "E2", ctx.pols.E2[ctx.step]);
    printU32(ctx, "E1", ctx.pols.E1[ctx.step]);
    printReg(ctx, "E0", ctx.pols.E0[ctx.step]);
    printU32(ctx, "SR7", ctx.pols.SR7[ctx.step]);
    printU32(ctx, "SR6", ctx.pols.SR6[ctx.step]);
    printU32(ctx, "SR5", ctx.pols.SR5[ctx.step]);
    printU32(ctx, "SR4", ctx.pols.SR4[ctx.step]);
    printU32(ctx, "SR3", ctx.pols.SR3[ctx.step]);
    printU32(ctx, "SR2", ctx.pols.SR2[ctx.step]);
    printU32(ctx, "SR1", ctx.pols.SR1[ctx.step]);
    printU32(ctx, "SR0", ctx.pols.SR0[ctx.step]);
    printU32(ctx, "CTX", ctx.pols.CTX[ctx.step]);
    printU16(ctx, "SP", ctx.pols.SP[ctx.step]);
    printU32(ctx, "PC", ctx.pols.PC[ctx.step]);
    printU32(ctx, "MAXMEM", ctx.pols.MAXMEM[ctx.step]);
    printU64(ctx, "GAS", ctx.pols.GAS[ctx.step]);
    printU32(ctx, "zkPC", ctx.pols.zkPC[ctx.step]);
    FieldElement step;
