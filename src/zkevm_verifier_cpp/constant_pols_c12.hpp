...
public:
    ...
    GlobalConstantPolsC12 (void * pAddress, uint64_t degree) :
...
public:
    ...
    CompressorConstantPolsC12 (void * pAddress, uint64_t degree) :
        S{
...
public:
    ...
    ConstantPolsC12 (void * pAddress, uint64_t degree) :
