...
#include "fibonacci.chelpers.step52ns.parser.hpp"
#include <immintrin.h>

void FibonacciSteps::step52ns_parser_first_avx(StepsParams &params, uint64_t nrows, uint64_t nrowsBatch)
{
...
void FibonacciSteps::step52ns_parser_first(StepsParams &params, uint64_t nrows, uint64_t nrowsBatch)
{
#pragma omp parallel for
     for (uint64_t i = 0; i < nrows; i += nrowsBatch)
     {
...
#ifdef __AVX512__
void FibonacciSteps::step52ns_parser_first_avx512(StepsParams &params, uint64_t nrows, uint64_t nrowsBatch)
{
