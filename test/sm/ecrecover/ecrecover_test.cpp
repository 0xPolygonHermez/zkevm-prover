...
ECRecoverTestVector ecrecoverTestVectors[] = {
    { "57e7a14390cd9b6d76032484b266b8263bf59c4c0c0cbbf8e2b3f9e66c825bf8", "1cee7e01dc62f69a12c3510c6d64de04ee6346d84b6a017f3e786c7d87f963e7", "5d8cc91fa983cd6d9cf55fff80d73bd26cd333b0f098acc1e58edb1fd484ad73", "1b", true }
};
...
void ECRecoverTest (void)
{
    ...
    for (uint64_t i=0; i<1; i++)
    {
        ...
        bResult = ECRecover(hash, r, s, v);
        if (bResult != ecrecoverTestVectors[i].result)
        {
            zklog.error("ECRecoverTest() failed i=" + to_string(i) + " hash=" + ecrecoverTestVectors[i].hash);
        }
    }
